...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/citizens-pulse/pull/17" class=".btn">#17</a>
            </td>
            <td>
                <b>
                    Bump url-parse from 1.4.7 to 1.5.10 in /webui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/citizens-pulse/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-28 03:12:35 +0000 UTC
    </div>
</div>
