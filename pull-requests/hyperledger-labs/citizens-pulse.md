...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/citizens-pulse/pull/20" class=".btn">#20</a>
            </td>
            <td>
                <b>
                    Bump minimist from 1.2.5 to 1.2.6 in /webui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/citizens-pulse/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-01 15:22:01 +0000 UTC
    </div>
</div>
