...
You can clone this repo on <span class="fs-3">[GitHub](https://github.com/hyperledger-labs/byzantine-config){: .btn .mr-4 }</span>
...
<div class="code-example" markdown="1">
    <table>
        <tr>
            <td>
                PR [#25](https://api.github.com/repos/hyperledger-labs/byzantine-config/pulls/25)
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/byzantine-config/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-04-20 00:33:14 +0000 UTC
    </div>
</div>
