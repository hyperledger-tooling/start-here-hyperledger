...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/13" class=".btn">#13</a>
            </td>
            <td>
                <b>
                    Bump follow-redirects from 1.14.4 to 1.14.8 in /samples/minitoken-besu-ethereum
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-docs/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-15 13:01:43 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/11" class=".btn">#11</a>
            </td>
            <td>
                <b>
                    Bump nanoid from 3.1.30 to 3.2.0 in /docsrcs/yui-ibc-solidity
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-docs/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-10 06:10:11 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/10" class=".btn">#10</a>
            </td>
            <td>
                <b>
                    Bump shelljs from 0.8.4 to 0.8.5 in /docsrcs/yui-ibc-solidity
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/9" class=".btn">#9</a>
            </td>
            <td>
                <b>
                    Bump follow-redirects from 1.14.4 to 1.14.8 in /docsrcs/yui-ibc-solidity
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-docs/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-10 06:10:05 +0000 UTC
    </div>
</div>
