...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/38" class=".btn">#38</a>
            </td>
            <td>
                <b>
                    Bump loader-utils from 1.4.0 to 1.4.2 in /docsrcs/yui-ibc-solidity
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-docs/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-11-16 08:54:58 +0000 UTC
    </div>
</div>
