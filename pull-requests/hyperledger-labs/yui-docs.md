...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-docs/pull/20" class=".btn">#20</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /docsrcs/yui-ibc-solidity
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-docs/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-29 17:11:30 +0000 UTC
    </div>
</div>
