...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/71" class=".btn">#71</a>
            </td>
            <td>
                <b>
                    Change to use Java CC in this repo for K8s integration tests
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                This PR changes asset-transfer-basic/chaincode-java used in K8s integration tests to use the
one in sample-environments/fabric-samples instead of the original fabric-samples.
This is intended to stabilize the tests.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2023-02-28 00:04:01 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/70" class=".btn">#70</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump golang.org/x/text from 0.3.7 to 0.3.8 in /sample-environments/fabric-samples/asset-transfer-private-data/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 12:05:33 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/69" class=".btn">#69</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump golang.org/x/text from 0.3.7 to 0.3.8 in /sample-environments/fabric-samples/asset-transfer-basic/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 02:51:25 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/68" class=".btn">#68</a>
            </td>
            <td>
                <b>
                    Prepare for v2.5
        ...
        <tr>
            ...
            <td>
                This PR prepares for Fabric v2.5 support.
- Update integration tests for v2.5 series
  - Currently using 2.5.0-beta
  - Simultaneously remove v2.4 series from the scope
  - Simultaneously bump v2.2 series to 2.2.10
- Update the node version of Agent and API server to 16
- Update the node packages and the go packages
- Other minor improvements
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2023-02-21 01:20:41 +0000 UTC
    </div>
</div>
