...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/108" class=".btn">#108</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump golang.org/x/net from 0.7.0 to 0.23.0 in /sample-environments/fabric-samples/asset-transfer-basic/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-04-19 13:54:05 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/107" class=".btn">#107</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump golang.org/x/net from 0.0.0-20220708220712-1185a9018129 to 0.23.0 in /sample-environments/fabric-samples/asset-transfer-private-data/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Bumps [golang.org/x/net](https://github.com/golang/net) from 0.0.0-20220708220712-1185a9018129 to 0.23.0.
<details>
<summary>Commits</summary>
<ul>
<li>See full diff in <a href="https://github.com/golang/net/commits/v0.23.0">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=golang.org/x/net&package-manager=go_modules&previous-version=0.0.0-20220708220712-1185a9018129&new-version=0.23.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-04-19 11:00:32 +0000 UTC
    </div>
</div>
