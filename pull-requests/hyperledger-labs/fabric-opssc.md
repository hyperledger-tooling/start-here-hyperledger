...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/101" class=".btn">#101</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump follow-redirects from 1.15.2 to 1.15.6 in /opssc-agent/src
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-16 01:48:46 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/100" class=".btn">#100</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump follow-redirects from 1.15.2 to 1.15.6 in /opssc-api-server/src
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/99" class=".btn">#99</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump follow-redirects from 1.15.2 to 1.15.6 in /common/src
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-16 01:48:45 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/98" class=".btn">#98</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump follow-redirects from 1.14.8 to 1.15.6 in /integration
                </b>
            </td>
        </tr>
        <tr>
...
<li><a href="https://github.com/follow-redirects/follow-redirects/commit/1cba8e85fa73f563a439fe460cf028688e4358df"><code>1cba8e8</code></a> Prefer native URL instead of legacy url.resolve.</li>
<li><a href="https://github.com/follow-redirects/follow-redirects/commit/72bc2a4229bc18dc9fbd57c60579713e6264cb92"><code>72bc2a4</code></a> Simplify _processResponse error handling.</li>
<li>Additional commits viewable in <a href="https://github.com/follow-redirects/follow-redirects/compare/v1.14.8...v1.15.6">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=follow-redirects&package-manager=npm_and_yarn&previous-version=1.14.8&new-version=1.15.6)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-15 12:55:47 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/97" class=".btn">#97</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump google.golang.org/protobuf from 1.28.1 to 1.33.0 in /sample-environments/fabric-samples/asset-transfer-basic/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-13 22:16:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/96" class=".btn">#96</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump google.golang.org/protobuf from 1.28.1 to 1.33.0 in /chaincode/chaincode-ops
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-13 22:09:13 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/95" class=".btn">#95</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump google.golang.org/protobuf from 1.28.1 to 1.33.0 in /chaincode/channel-ops
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-13 22:09:11 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/94" class=".btn">#94</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump google.golang.org/protobuf from 1.28.0 to 1.33.0 in /sample-environments/fabric-samples/asset-transfer-private-data/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-03-13 21:50:30 +0000 UTC
    </div>
</div>
