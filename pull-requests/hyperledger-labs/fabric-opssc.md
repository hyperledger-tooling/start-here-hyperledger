...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/37" class=".btn">#37</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump ansi-regex from 3.0.0 to 3.0.1 in /integration
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-10 23:35:10 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/36" class=".btn">#36</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump moment from 2.29.1 to 2.29.2 in /common/src
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-09 08:56:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/35" class=".btn">#35</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump moment from 2.29.1 to 2.29.2 in /integration
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-09 08:56:18 +0000 UTC
    </div>
</div>
