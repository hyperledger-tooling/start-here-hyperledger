...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-opssc/pull/77" class=".btn">#77</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump google.golang.org/grpc from 1.48.0 to 1.53.0 in /sample-environments/fabric-samples/asset-transfer-private-data/chaincode-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-opssc/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-05 21:27:41 +0000 UTC
    </div>
</div>
