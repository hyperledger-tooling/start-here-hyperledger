...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-credential-payment/pull/7" class=".btn">#7</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/perun-credential-payment/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-03-07 03:29:38 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-credential-payment/pull/6" class=".btn">#6</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/perun-credential-payment/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-03-07 03:29:27 +0000 UTC
    </div>
</div>
