...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    ATL-6021 receive store presentation
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/814" class=".btn">#814</a>
            </td>
            <td>
                <b>
                    feat: Consumer restricition parametarization 
                </b>
            </td>
        </tr>
        <tr>
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2023-12-12 22:08:02 +0000 UTC
    </div>
</div>
