...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/726" class=".btn">#726</a>
            </td>
            <td>
                <b>
...
This PR supersedes #710 and is recreated to ensure DCO sign off is correct
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2023-09-18 10:05:16 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/725" class=".btn">#725</a>
            </td>
            <td>
                <b>
                    feat: ATL-5777 - Adding update argostate with new release
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                # Overview
Update integration environments on new release
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2023-09-17 23:08:36 +0000 UTC
    </div>
</div>
