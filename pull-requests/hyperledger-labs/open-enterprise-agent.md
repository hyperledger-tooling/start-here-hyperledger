...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/829" class=".btn">#829</a>
            </td>
            <td>
                <b>
                    feat(pollux): Implement endpoint that returns status list credential
                </b>
            </td>
        </tr>
        <tr>
...
[Fixes ATL-6136](https://input-output.atlassian.net/browse/ATL-6136)
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2023-12-22 02:40:25 +0000 UTC
    </div>
</div>
