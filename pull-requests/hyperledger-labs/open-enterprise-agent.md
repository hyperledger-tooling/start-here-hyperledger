...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/905" class=".btn">#905</a>
            </td>
            <td>
                <b>
                    fix: correct the config environment variable name
                </b>
            </td>
        </tr>
        <tr>
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2024-02-22 11:26:47 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/open-enterprise-agent/pull/904" class=".btn">#904</a>
            </td>
            <td>
                <b>
...
* [ ] If yes to above: I have taken care to cover edge cases in my tests
    ...
    <div class="right-align">
        Created At 2024-02-21 14:30:01 +0000 UTC
    </div>
</div>
