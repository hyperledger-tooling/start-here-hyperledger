...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/pluggable-hcs/pull/47" class=".btn">#47</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/sys from 0.0.0-20190813064441-fde4db37ae7a to 0.1.0 in /first-network/chaincode/abstore/go
                </b>
            </td>
        </tr>
        <tr>
...
[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=golang.org/x/sys&package-manager=go_modules&previous-version=0.0.0-20190813064441-fde4db37ae7a&new-version=0.1.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/pluggable-hcs/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-25 03:53:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/pluggable-hcs/pull/46" class=".btn">#46</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/net from 0.0.0-20190813141303-74dc4d7220e7 to 0.7.0 in /first-network/chaincode/abstore/go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/pluggable-hcs/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-24 18:48:30 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/pluggable-hcs/pull/45" class=".btn">#45</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/text from 0.3.2 to 0.3.8 in /first-network/chaincode/abstore/go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/pluggable-hcs/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 01:32:08 +0000 UTC
    </div>
</div>
