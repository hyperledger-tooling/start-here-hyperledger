...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-relayer/pull/81" class=".btn">#81</a>
            </td>
            <td>
                <b>
                    build(deps): bump golang.org/x/net from 0.0.0-20220617184016-355a448f1bc9 to 0.7.0
                </b>
            </td>
        </tr>
        <tr>
...
[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=golang.org/x/net&package-manager=go_modules&previous-version=0.0.0-20220617184016-355a448f1bc9&new-version=0.7.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-relayer/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-25 01:06:28 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-relayer/pull/80" class=".btn">#80</a>
            </td>
            <td>
                <b>
                    build(deps): bump golang.org/x/net from 0.0.0-20220617184016-355a448f1bc9 to 0.7.0 in /tests/chains/tendermint
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-relayer/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-25 01:06:21 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-relayer/pull/79" class=".btn">#79</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-relayer/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 11:31:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-relayer/pull/78" class=".btn">#78</a>
            </td>
            <td>
                <b>
                    build(deps): bump golang.org/x/text from 0.3.7 to 0.3.8 in /tests/chains/tendermint
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-relayer/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 04:48:03 +0000 UTC
    </div>
</div>
