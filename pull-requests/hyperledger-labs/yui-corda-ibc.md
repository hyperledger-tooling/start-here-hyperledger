...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/yui-corda-ibc/pull/54" class=".btn">#54</a>
            </td>
            <td>
                <b>
                    Bump github.com/prometheus/client_golang from 1.10.0 to 1.11.1 in /fabric-ibc-lightclientd
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/yui-corda-ibc/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-15 02:38:56 +0000 UTC
    </div>
</div>
