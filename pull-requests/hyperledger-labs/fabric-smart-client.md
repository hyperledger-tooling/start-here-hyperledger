...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-smart-client/pull/471" class=".btn">#471</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-smart-client/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-04-04 21:23:38 +0000 UTC
    </div>
</div>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-smart-client/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-03-29 14:49:26 +0000 UTC
    </div>
</div>
