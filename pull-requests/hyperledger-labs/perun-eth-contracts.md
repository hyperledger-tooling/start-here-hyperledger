...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-eth-contracts/pull/38" class=".btn">#38</a>
            </td>
            <td>
                <b>
                    ⬆️ Bump http-cache-semantics from 4.1.0 to 4.1.1
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/perun-eth-contracts/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-03 11:38:00 +0000 UTC
    </div>
</div>
