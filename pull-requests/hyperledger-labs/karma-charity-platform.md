...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/90" class=".btn">#90</a>
            </td>
            <td>
                <b>
                    Bump http-cache-semantics from 4.1.0 to 4.1.1 in /explorer/frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-04 12:51:10 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/89" class=".btn">#89</a>
            </td>
            <td>
                <b>
                    Bump http-cache-semantics from 4.1.0 to 4.1.1 in /platform/frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-04 12:51:00 +0000 UTC
    </div>
</div>
