...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/65" class=".btn">#65</a>
            </td>
            <td>
                <b>
                    Bump loader-utils from 1.4.0 to 1.4.1 in /explorer/frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-11-09 08:21:08 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/64" class=".btn">#64</a>
            </td>
            <td>
                <b>
                    Bump loader-utils from 2.0.2 to 2.0.3 in /platform/frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-11-09 08:21:01 +0000 UTC
    </div>
</div>
