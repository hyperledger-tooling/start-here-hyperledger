...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/121" class=".btn">#121</a>
            </td>
            <td>
                <b>
                    Bump protobufjs from 6.11.3 to 6.11.4 in /chaincode
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-08-16 00:00:05 +0000 UTC
    </div>
</div>
