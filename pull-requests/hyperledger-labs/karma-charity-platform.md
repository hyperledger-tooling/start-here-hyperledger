...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/karma-charity-platform/pull/111" class=".btn">#111</a>
            </td>
            <td>
                <b>
                    Bump tough-cookie from 4.1.2 to 4.1.3 in /explorer/backend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/karma-charity-platform/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-09 22:55:37 +0000 UTC
    </div>
</div>
