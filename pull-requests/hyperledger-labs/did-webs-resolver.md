...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/did-webs-resolver/pull/8" class=".btn">#8</a>
            </td>
            <td>
                <b>
                    Feat/initial keri cesr
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Draft until I can sync with Markus, etc.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2023-10-02 20:04:22 +0000 UTC
    </div>
</div>
