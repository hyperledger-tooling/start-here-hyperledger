...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/674" class=".btn">#674</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            ...
            <td>
                Attempt to resolve [issue 666](https://github.com/hyperledger-labs/blockchain-carbon-accounting/issues/666) 
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2023-02-25 05:00:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/673" class=".btn">#673</a>
            </td>
            <td>
                <b>
                    Bump sequelize from 6.28.2 to 6.29.0
                </b>
            </td>
        </tr>
        <tr>
...
<li>See full diff in <a href="https://github.com/sequelize/sequelize/compare/v6.28.2...v6.29.0">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=sequelize&package-manager=npm_and_yarn&previous-version=6.28.2&new-version=6.29.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-25 01:36:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/672" class=".btn">#672</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/text from 0.3.7 to 0.3.8 in /fabric/multi-cloud-deployment/chaincode
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 07:41:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/671" class=".btn">#671</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/text from 0.3.7 to 0.3.8 in /fabric/chaincode/datalock
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/670" class=".btn">#670</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/text from 0.3.7 to 0.3.8 in /fabric/multi-cloud-deployment/deploy-aws/chaincode
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 07:41:13 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/669" class=".btn">#669</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            ...
            <td>
                Bumps [sequelize](https://github.com/sequelize/sequelize) from 6.20.1 to 6.28.2.
<details>
<summary>Release notes</summary>
<p><em>Sourced from <a href="https://github.com/sequelize/sequelize/releases">sequelize's releases</a>.</em></p>
<blockquote>
...
<li>Additional commits viewable in <a href="https://github.com/sequelize/sequelize/compare/v6.20.1...v6.28.2">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=sequelize&package-manager=npm_and_yarn&previous-version=6.20.1&new-version=6.28.2)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 04:08:28 +0000 UTC
    </div>
</div>
