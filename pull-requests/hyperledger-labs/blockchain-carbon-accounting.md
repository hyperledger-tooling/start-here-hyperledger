...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/537" class=".btn">#537</a>
            </td>
            <td>
                <b>
                    get code up to date
        ...
        <tr>
            ...
            <td>
                Most basic features of request audit, queueing the requests, assigning to auditors, issuing tokens are now working.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2022-04-29 19:15:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/536" class=".btn">#536</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /open-offsets-directory/react
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-28 16:38:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/535" class=".btn">#535</a>
            </td>
            <td>
                <b>
                    get code up to date
    ...
    <div class="right-align">
        Created At 2022-04-28 16:22:05 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/532" class=".btn">#532</a>
            </td>
            <td>
                <b>
                    get code up to date
    ...
    <div class="right-align">
        Created At 2022-04-25 20:14:03 +0000 UTC
    </div>
</div>
