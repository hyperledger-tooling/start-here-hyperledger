...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/163" class=".btn">#163</a>
            </td>
            <td>
                <b>
                    Bump lodash from 4.17.20 to 4.17.21 in /utility-emissions-channel/docker-compose-setup
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-05-12 00:09:43 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/162" class=".btn">#162</a>
            </td>
            <td>
                <b>
                    Bump lodash from 4.17.20 to 4.17.21 in /net-emissions-token-network/interface/packages/subgraph
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-05-11 23:55:41 +0000 UTC
    </div>
</div>
