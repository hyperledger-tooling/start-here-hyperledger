...
<div>
    ...
    <div class="right-align">
        Created At 2021-06-09 21:48:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/172" class=".btn">#172</a>
            </td>
            <td>
                <b>
                    Bump normalize-url from 4.5.0 to 4.5.1 in /utility-emissions-channel/typescript_app
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-06-09 21:46:06 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/171" class=".btn">#171</a>
            </td>
            <td>
                <b>
                    Bump glob-parent from 5.1.1 to 5.1.2 in /net-emissions-token-network/interface/packages/subgraph
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-carbon-accounting/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-06-09 21:46:05 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-carbon-accounting/pull/169" class=".btn">#169</a>
            </td>
            <td>
                <b>
                    Fixes bugs to get utility-emissions-channel up and running #98
                </b>
            </td>
        </tr>
        <tr>
...
This PR is to fix all the bugs occurring  to get the utility-emissions-channel up and running.

**1st Commit:**
- Fixes the Null values in data array obtained from parsing XLSX files.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2021-06-06 13:40:57 +0000 UTC
    </div>
</div>
