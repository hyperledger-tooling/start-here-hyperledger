...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/weaver-dlt-interoperability/pull/388" class=".btn">#388</a>
            </td>
            <td>
                <b>
                    Bump openssl from 0.10.41 to 0.10.48 in /core/relay
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/weaver-dlt-interoperability/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-03-25 02:00:42 +0000 UTC
    </div>
</div>
