...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/weaver-dlt-interoperability/pull/275" class=".btn">#275</a>
            </td>
            <td>
                <b>
                    Bump eventsource from 1.1.0 to 1.1.1 in /docs
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/weaver-dlt-interoperability/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-06-01 22:08:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/weaver-dlt-interoperability/pull/274" class=".btn">#274</a>
            </td>
            <td>
                <b>
                    Minor Fixes
        ...
        <tr>
            ...
            <td>
                1. Fix fabric driver Dockerfile.
2. Bump version 1.3.1
3. Update fabric go chaincode `go.mod` weaver dependencies.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2022-06-01 18:30:44 +0000 UTC
    </div>
</div>
