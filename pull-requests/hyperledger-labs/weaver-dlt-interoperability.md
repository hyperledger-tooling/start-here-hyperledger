...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/weaver-dlt-interoperability/pull/382" class=".btn">#382</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/crypto from 0.0.0-20210322153248-0c34fe9e7dc2 to 0.1.0 in /core/network/fabric-interop-cc/contracts/interop
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/weaver-dlt-interoperability/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-25 02:25:20 +0000 UTC
    </div>
</div>
