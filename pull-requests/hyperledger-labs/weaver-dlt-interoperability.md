...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/weaver-dlt-interoperability/pull/418" class=".btn">#418</a>
            </td>
            <td>
                <b>
                    build(deps-dev): Bump word-wrap from 1.2.3 to 1.2.4 in /common/policy-dsl
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/weaver-dlt-interoperability/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-19 01:59:10 +0000 UTC
    </div>
</div>
