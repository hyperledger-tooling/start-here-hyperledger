...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fablo/pull/302" class=".btn">#302</a>
            </td>
            <td>
                <b>
                    Bump tar from 4.4.13 to 4.4.19 in /samples/chaincodes/chaincode-kv-node
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fablo/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-05 11:51:25 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fablo/pull/301" class=".btn">#301</a>
            </td>
            <td>
                <b>
                    Bump color-string from 1.5.3 to 1.9.0 in /samples/chaincodes/chaincode-kv-node
                </b>
            </td>
        </tr>
        <tr>
...
<summary>Commits</summary>
<ul>
<li>See full diff in <a href="https://github.com/Qix-/color-string/commits/1.9.0">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=color-string&package-manager=npm_and_yarn&previous-version=1.5.3&new-version=1.9.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fablo/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-05 11:51:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fablo/pull/300" class=".btn">#300</a>
            </td>
            <td>
                <b>
                    V1.0.2
    ...
    <div class="right-align">
        Created At 2022-04-05 11:10:29 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fablo/pull/297" class=".btn">#297</a>
            </td>
            <td>
                <b>
                    Bump minimist from 1.2.5 to 1.2.6 in /samples/chaincodes/chaincode-kv-node-1.4
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fablo/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-03-30 02:26:25 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fablo/pull/296" class=".btn">#296</a>
            </td>
            <td>
                <b>
                    Bump minimist from 1.2.5 to 1.2.6 in /samples/chaincodes/chaincode-kv-node
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fablo/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-03-29 13:37:44 +0000 UTC
    </div>
</div>
