...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/144" class=".btn">#144</a>
            </td>
            <td>
                <b>
                    Bump follow-redirects from 1.14.7 to 1.14.9 in /packages/athena
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-operations-console/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-19 02:17:24 +0000 UTC
    </div>
</div>
