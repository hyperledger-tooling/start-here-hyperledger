...
- update release notes
    ...
    <div class="right-align">
        Created At 2024-02-21 07:15:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/635" class=".btn">#635</a>
            </td>
            <td>
                <b>
                    update flat swagger
...
update flat swagger
    ...
    <div class="right-align">
        Created At 2024-02-20 20:41:05 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/634" class=".btn">#634</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-operations-console/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-02-20 19:51:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/633" class=".btn">#633</a>
            </td>
            <td>
                <b>
...
- fixes bearer token generation when auth is an api key
- uses swagger file for validation of the create-access-token api
