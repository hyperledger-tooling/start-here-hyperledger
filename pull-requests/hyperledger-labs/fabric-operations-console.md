...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/477" class=".btn">#477</a>
            </td>
            <td>
                <b>
                    Bump socket.io-parser from 4.2.1 to 4.2.3 in /packages/stitch
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-operations-console/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-05-24 00:48:22 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/476" class=".btn">#476</a>
            </td>
            <td>
                <b>
                    set allow_default_password as false for migration
                </b>
            </td>
        </tr>
        <tr>
...
#### Description
A new console migration will now set `allow_default_password ` as `false`, instead of `true`
    ...
    <div class="right-align">
        Created At 2023-05-23 23:08:17 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/475" class=".btn">#475</a>
            </td>
            <td>
                <b>
                    fix error when appending new orderer
                </b>
            </td>
        </tr>
        <tr>
...
#### Description
- fixed an error when adding a new orderer to an existing ordering service
- adding a lot more debug logs around the appending orderer flow
- fix error handling around the appending orderer flow, the code will now stop on the first "fatal" error, instead of continuing and showing the last (meaningless) error
    ...
    <div class="right-align">
        Created At 2023-05-23 22:55:31 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/473" class=".btn">#473</a>
            </td>
            <td>
                <b>
                    VSCode link removal from install chaincode
                </b>
            </td>
        </tr>
        <tr>
...
VSCode link removal from install chaincode
    ...
    <div class="right-align">
        Created At 2023-05-17 12:06:17 +0000 UTC
    </div>
</div>
