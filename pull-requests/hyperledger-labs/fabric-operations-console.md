...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/143" class=".btn">#143</a>
            </td>
            <td>
                <b>
                    Fixup join channel via osnadmin
                </b>
            </td>
        </tr>
        <tr>
...
- New feature
  - fixes join channel via osnadmin endpoint
  - adds new a generic proxy route w/mutual tls support & multipart content type support
...
<!--- Describe your changes in detail, including motivation. -->
    ...
    <div class="right-align">
        Created At 2022-02-18 22:05:49 +0000 UTC
    </div>
</div>
