...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/349" class=".btn">#349</a>
            </td>
            <td>
                <b>
                    Bump json5 from 2.2.1 to 2.2.3 in /packages/apollo
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-operations-console/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-01-02 07:56:39 +0000 UTC
    </div>
</div>
