...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/753" class=".btn">#753</a>
            </td>
            <td>
                <b>
                    Console Automation - Blank screen appears while clicking on MSP Identify dropdown
                </b>
            </td>
        </tr>
        <tr>
...
- Fix for blank screen appears while clicking on MSP Identify dropdown
    ...
    <div class="right-align">
        Created At 2024-06-18 09:37:47 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/752" class=".btn">#752</a>
            </td>
            <td>
                <b>
                    updated doc link for release notes
                </b>
            </td>
        </tr>
        <tr>
...
#### Description
Earlier link was not valid anymore, so updated the document link for release notes option
    ...
    <div class="right-align">
        Created At 2024-06-18 09:28:08 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/750" class=".btn">#750</a>
            </td>
            <td>
                <b>
                    Bump ws from 7.5.9 to 7.5.10 in /packages/apollo
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/fabric-operations-console/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-06-18 07:45:30 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/749" class=".btn">#749</a>
            </td>
            <td>
                <b>
                    ca and orderer detail patch available ui fix and ordering node screen load issue fix
                </b>
            </td>
        </tr>
        <tr>
...
#### Description
<!--- Describe your changes in detail, including motivation. -->
- Update available screen issue fix on CA and Orderer Detail screen
- Fix issue while reloading ordering node screen
    ...
    <div class="right-align">
        Created At 2024-06-18 07:40:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/748" class=".btn">#748</a>
            </td>
            <td>
                <b>
                    Bump ws from 7.4.6 to 7.5.10 in /packages/athena
                </b>
            </td>
        </tr>
        <tr>
...
<li>Additional commits viewable in <a href="https://github.com/websockets/ws/compare/7.4.6...7.5.10">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=ws&package-manager=npm_and_yarn&previous-version=7.4.6&new-version=7.5.10)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/743" class=".btn">#743</a>
            </td>
            <td>
                <b>
...
#### Description
<!--- Describe your changes in detail, including motivation. -->
- Update nodejs version 18 to 20
    ...
    <div class="right-align">
        Created At 2024-06-17 05:28:41 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/741" class=".btn">#741</a>
            </td>
            <td>
                <b>
                    library update issue fixes
                </b>
            </td>
        </tr>
        <tr>
...
- HTML Rendering issue on re-enroll user
- UI issue on peer detail page
- Ordering service node detail page loading issue
- Blank Ordering Service page is displayed navigating from ordering service node page
- Add button alignment issue in Create Channel -> Organisations screen
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2024-06-14 20:28:39 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/738" class=".btn">#738</a>
            </td>
            <td>
                <b>
                    bump release note
...
<!--- Describe your changes in detail, including motivation. -->
    ...
    <div class="right-align">
        Created At 2024-06-12 10:47:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/fabric-operations-console/pull/737" class=".btn">#737</a>
            </td>
            <td>
                <b>
                    max update limit exceed issue fix on msp creation
                </b>
            </td>
        </tr>
        <tr>
...
#### Description
<!--- Describe your changes in detail, including motivation. -->
- Fix Error: Maximum update depth exceeded

            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2024-06-12 10:20:40 +0000 UTC
    </div>
</div>
