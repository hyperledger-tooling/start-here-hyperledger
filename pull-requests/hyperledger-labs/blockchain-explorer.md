...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-explorer/pull/457" class=".btn">#457</a>
            </td>
            <td>
                <b>
...
```
    ...
    <div class="right-align">
        Created At 2023-09-27 10:01:36 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-explorer/pull/456" class=".btn">#456</a>
            </td>
            <td>
                <b>
                    Package fix
...
#### What this PR does / why we need it:
To reduce the packages vulnerabilities.
#### Which issue(s) this PR fixes:
<!--
...
```
    ...
    <div class="right-align">
        Created At 2023-09-26 07:40:28 +0000 UTC
    </div>
</div>
