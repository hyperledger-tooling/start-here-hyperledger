...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-explorer/pull/474" class=".btn">#474</a>
            </td>
            <td>
                <b>
                    Boottime-Feature-UI
...
This Boot-Time Feature PR will display "Total Blocks" column in channel page and hovering upon the info icon of Blocks, Total Blocks and Transactions columns, will show the respective messages.
...
```
    ...
    <div class="right-align">
        Created At 2023-11-30 10:33:29 +0000 UTC
    </div>
</div>
