...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/nft-community-footprint/pull/7" class=".btn">#7</a>
            </td>
            <td>
                <b>
                    Bump tough-cookie from 4.0.0 to 4.1.3 in /application
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/nft-community-footprint/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-09 18:52:44 +0000 UTC
    </div>
</div>
