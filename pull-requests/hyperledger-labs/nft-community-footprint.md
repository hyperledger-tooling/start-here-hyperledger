...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/nft-community-footprint/pull/8" class=".btn">#8</a>
            </td>
            <td>
                <b>
                    Bump word-wrap from 1.2.3 to 1.2.4 in /application
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/nft-community-footprint/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-19 20:18:14 +0000 UTC
    </div>
</div>
