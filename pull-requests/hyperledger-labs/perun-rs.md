...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-rs/pull/7" class=".btn">#7</a>
            </td>
            <td>
                <b>
                    Add MAINTAINERS and NOTICE files
                </b>
            </td>
        </tr>
        <tr>
    ...
    <div class="right-align">
        Created At 2023-03-15 17:46:03 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-rs/pull/5" class=".btn">#5</a>
            </td>
            <td>
                <b>
                    build(deps): bump golang.org/x/crypto from 0.0.0-20210921155107-089bfa567519 to 0.1.0 in /examples/go-integration
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/perun-rs/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-03-15 16:24:39 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/perun-rs/pull/4" class=".btn">#4</a>
            </td>
            <td>
                <b>
...
The table compares rust-perun to go-perun and lists the (intentionally chosen) technical debt and the thus resulting limitations to how rust-perun can be used.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2023-03-15 15:52:42 +0000 UTC
    </div>
</div>
