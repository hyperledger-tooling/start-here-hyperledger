...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/university-course/pull/60" class=".btn">#60</a>
            </td>
            <td>
                <b>
                    chore(deps): bump path-parse from 1.0.6 to 1.0.7 in /support/Lab06/b4s/organization/university/user-interface
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/university-course/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-08-12 21:20:50 +0000 UTC
    </div>
</div>
