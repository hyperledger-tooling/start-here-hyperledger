...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/university-course/pull/61" class=".btn">#61</a>
            </td>
            <td>
                <b>
                    chore(deps): bump url-parse from 1.4.7 to 1.5.3 in /support/Lab06/b4s/organization/university/user-interface
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/university-course/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-10-06 21:27:05 +0000 UTC
    </div>
</div>
