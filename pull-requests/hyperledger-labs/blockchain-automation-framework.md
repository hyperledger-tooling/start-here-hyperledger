...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    [fabric] Ansible decoupling for setup/vault_kubernetes role
                </b>
            </td>
        </tr>
        <tr>
...
**Changelog**
- Add create/k8s_secrets role and vault_kubernetes chart
- Update setup/vault_kubernetes role
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-automation-framework/pull/1619" class=".btn">#1619</a>
            </td>
            <td>
                <b>
                    Bump path-parse from 1.0.6 to 1.0.7 in /platforms/r3-corda/images/networkmap/website
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-automation-framework/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-08-13 00:39:26 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/blockchain-automation-framework/pull/1618" class=".btn">#1618</a>
            </td>
            <td>
                <b>
                    Bump path-parse from 1.0.6 to 1.0.7 in /platforms/r3-corda/images/doorman/website
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/blockchain-automation-framework/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-08-13 00:39:25 +0000 UTC
    </div>
</div>
