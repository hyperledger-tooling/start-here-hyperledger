...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/pull/28" class=".btn">#28</a>
            </td>
            <td>
                <b>
                    Bump hosted-git-info from 2.7.1 to 2.8.9 in /attributebased/javascript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-05-11 04:58:59 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/pull/27" class=".btn">#27</a>
            </td>
            <td>
                <b>
                    Bump lodash from 4.17.11 to 4.17.21 in /attributebased/javascript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-05-10 16:58:02 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/pull/26" class=".btn">#26</a>
            </td>
            <td>
                <b>
                    Bump handlebars from 4.1.0 to 4.7.7 in /attributebased/javascript
                </b>
            </td>
        </tr>
        <tr>
...
[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=handlebars&package-manager=npm_and_yarn&previous-version=4.1.0&new-version=4.7.7)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/hyperledger-fabric-based-access-control/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-05-08 08:12:27 +0000 UTC
    </div>
</div>
