...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger-labs/mosaique-decentralized-workflows/pull/17" class=".btn">#17</a>
            </td>
            <td>
                <b>
                    Bump @sideway/formula from 3.0.0 to 3.0.1 in /visual-editor
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger-labs/mosaique-decentralized-workflows/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-09 09:08:14 +0000 UTC
    </div>
</div>
