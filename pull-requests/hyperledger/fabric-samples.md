...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/902" class=".btn">#902</a>
            </td>
            <td>
                <b>
...
Signed-off-by: Matthew B White <whitemat@uk.ibm.com>
    ...
    <div class="right-align">
        Created At 2023-01-09 14:17:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Bump json5 from 2.2.0 to 2.2.3 in /asset-transfer-basic/rest-api-typescript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-01-07 16:25:19 +0000 UTC
    </div>
</div>
