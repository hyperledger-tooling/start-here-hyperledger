...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Bump minimatch from 3.0.4 to 3.1.2 in /asset-transfer-basic/rest-api-typescript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-14 08:17:18 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/886" class=".btn">#886</a>
            </td>
            <td>
                <b>
                    Fix network.sh
...
Signed-off-by: Arnaud J Le Hors <lehors@us.ibm.com>
    ...
    <div class="right-align">
        Created At 2022-12-14 08:04:47 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/885" class=".btn">#885</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            ...
            <td>
                Updates the full stack sample to launch the operator with the multi-arch / arm64 image for the M1. 
...
Signed-off-by: Josh Kneubuhl <jkneubuh@us.ibm.com>
    ...
    <div class="right-align">
        Created At 2022-12-13 20:14:52 +0000 UTC
    </div>
</div>
