...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/1075" class=".btn">#1075</a>
            </td>
            <td>
                <b>
                    Bump word-wrap from 1.2.3 to 1.2.4 in /asset-transfer-basic/rest-api-typescript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-19 06:45:10 +0000 UTC
    </div>
</div>
