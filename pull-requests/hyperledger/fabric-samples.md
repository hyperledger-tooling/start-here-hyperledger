...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/755" class=".btn">#755</a>
            </td>
            <td>
                <b>
                    Bump protobufjs from 6.11.2 to 6.11.3 in /asset-transfer-basic/rest-api-typescript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-06-03 00:44:20 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-samples/pull/753" class=".btn">#753</a>
            </td>
            <td>
                <b>
                    Upgrade k8s chaincode builder to v0.5.0
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Upgrades the Kubernetes chaincode builder from v0.4.0 to v0.5.0.
...
Signed-off-by: Josh Kneubuhl <jkneubuh@us.ibm.com>
    ...
    <div class="right-align">
        Created At 2022-05-31 09:42:47 +0000 UTC
    </div>
</div>
