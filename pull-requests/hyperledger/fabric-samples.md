...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Bump jsrsasign from 10.5.1 to 10.5.25 in /asset-transfer-basic/rest-api-typescript
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Bumps [jsrsasign](https://github.com/kjur/jsrsasign) from 10.5.1 to 10.5.25.
<details>
...
<li>Additional commits viewable in <a href="https://github.com/kjur/jsrsasign/compare/10.5.1...10.5.25">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=jsrsasign&package-manager=npm_and_yarn&previous-version=10.5.1&new-version=10.5.25)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-06-25 07:25:57 +0000 UTC
    </div>
</div>
