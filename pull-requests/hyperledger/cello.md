...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cello/pull/535" class=".btn">#535</a>
            </td>
            <td>
                <b>
                    Bump certifi from 2022.12.7 to 2023.7.22 in /src/api-engine
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/cello/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-25 21:00:00 +0000 UTC
    </div>
</div>
