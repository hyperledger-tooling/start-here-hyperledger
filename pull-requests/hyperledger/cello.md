...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cello/pull/548" class=".btn">#548</a>
            </td>
            <td>
                <b>
                    Bump uwsgi from 2.0.18 to 2.0.22 in /src/api-engine
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Bumps [uwsgi](https://github.com/unbit/uwsgi-docs) from 2.0.18 to 2.0.22.
<details>
...
[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=uwsgi&package-manager=pip&previous-version=2.0.18&new-version=2.0.22)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/cello/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-08-24 20:11:45 +0000 UTC
    </div>
</div>
