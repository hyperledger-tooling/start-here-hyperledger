...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/708" class=".btn">#708</a>
            </td>
            <td>
                <b>
                    Updates
...
This PR fixes remaining issues after the merge of PR #698.
In particular, we ...
- upgrade to go 1.20 and update go dependencies accordingly
- upgrade to Fabric 2.5
- upgrade nanop proto compilier
- fix proto build for the IRB demo
- enable docker build-kit 
- replace marble chaincode with basic asset transfer chaincode from the fabric-samples repository
    ...
    <div class="right-align">
        Created At 2023-06-27 11:17:10 +0000 UTC
    </div>
</div>
