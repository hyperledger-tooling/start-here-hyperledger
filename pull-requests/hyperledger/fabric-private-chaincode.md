...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Bump github.com/quic-go/quic-go from 0.38.2 to 0.42.0 in /integration/go_chaincode in the go_modules group across 1 directory
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Bumps the go_modules group with 1 update in the /integration/go_chaincode directory: [github.com/quic-go/quic-go](https://github.com/quic-go/quic-go).

Updates `github.com/quic-go/quic-go` from 0.38.2 to 0.42.0
<details>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-private-chaincode/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-05-06 14:36:33 +0000 UTC
    </div>
</div>
