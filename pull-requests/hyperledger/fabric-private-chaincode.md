...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/706" class=".btn">#706</a>
            </td>
            <td>
                <b>
                    Bump github.com/docker/distribution from 2.7.1+incompatible to 2.8.2+incompatible in /samples/deployment/fabric-smart-client/the-simple-testing-network
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-private-chaincode/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-05-11 20:46:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/705" class=".btn">#705</a>
            </td>
            <td>
                <b>
                    Bump github.com/docker/distribution from 2.7.1+incompatible to 2.8.2+incompatible in /integration/go_chaincode
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-private-chaincode/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-05-11 20:45:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/704" class=".btn">#704</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-private-chaincode/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-05-11 20:44:44 +0000 UTC
    </div>
</div>
