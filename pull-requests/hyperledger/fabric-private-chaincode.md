...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/583" class=".btn">#583</a>
            </td>
            <td>
                <b>
                    Add the usage of fpcclient to the README of test-network deployment.
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <span class="chip">comp/samples</span><span class="chip">documentation</span>
            </td>
            <td>
                I add the usage of simple-cli-go (fpcclient) to the README of test-network deployment.
...
```
    ...
    <div class="right-align">
        Created At 2021-05-18 10:37:46 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Fix k8s deployment path setting
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                I fixed the problem that k8s deployment could not be executed due to the path being changed.
...
```
    ...
    <div class="right-align">
        Created At 2021-05-14 08:55:44 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-private-chaincode/pull/580" class=".btn">#580</a>
            </td>
            <td>
                <b>
                    Fix test-network path in simple-go and Readme for test-network sample
                </b>
            </td>
        </tr>
        <tr>
...
**What this PR does / why we need it**:
Fixes an error in simple-go chain code used in test-network sample as well as updates readme.
**Which issue(s) this PR fixes**:
<!--
  list existing bug, feature and/or work-item which this PR addresses.
  You might also consider creating an issue first for the PR.
...
-->
```
Updates Readme of sample test-network so that user understands the behaviour of one of the steps.
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2021-05-12 13:45:21 +0000 UTC
    </div>
</div>
