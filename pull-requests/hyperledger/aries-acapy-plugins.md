...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/432" class=".btn">#432</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            ...
            <td>
                Bumps the pip group with 1 update in the /basicmessage_storage/integration directory: [idna](https://github.com/kjd/idna).
Bumps the pip group with 3 updates in the /connection_update/integration directory: [idna](https://github.com/kjd/idna), [pillow](https://github.com/python-pillow/Pillow) and [pydantic](https://github.com/pydantic/pydantic).
Bumps the pip group with 3 updates in the /firebase_push_notifications directory: [idna](https://github.com/kjd/idna), [pydantic](https://github.com/pydantic/pydantic) and [black](https://github.com/psf/black).
Bumps the pip group with 1 update in the /firebase_push_notifications/integration directory: [idna](https://github.com/kjd/idna).
Bumps the pip group with 1 update in the /kafka_events/demo/setup directory: [idna](https://github.com/kjd/idna).
Bumps the pip group with 2 updates in the /kafka_events/integration directory: [idna](https://github.com/kjd/idna) and [black](https://github.com/psf/black).
...
Bumps the pip group with 1 update in the /multitenant_provider/integration directory: [idna](https://github.com/kjd/idna).
Bumps the pip group with 4 updates in the /oid4vci/integration directory: [idna](https://github.com/kjd/idna), [aiohttp](https://github.com/aio-libs/aiohttp), [pydantic](https://github.com/pydantic/pydantic) and [black](https://github.com/psf/black).
...
| [fastapi](https://github.com/tiangolo/fastapi) | `0.109.1` | `0.110.3` |

Bumps the pip group with 1 update in the /rpc/integration directory: [idna](https://github.com/kjd/idna).
...
Updates `pydantic` from 1.10.14 to 1.10.15
<details>
<summary>Release notes</summary>
...
<li>See full diff in <a href="https://github.com/pydantic/pydantic/compare/v1.10.14...v1.10.15">compare view</a></li>
</ul>
</details>
<br />
...
_Description has been truncated_
    ...
    <div class="right-align">
        Created At 2024-05-03 19:35:56 +0000 UTC
    </div>
</div>
