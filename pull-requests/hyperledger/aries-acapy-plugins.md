...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/198" class=".btn">#198</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Update pytest-cov requirement from 2.10.1 to 4.1.0 in /plugin_globals
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:50:02 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/196" class=".btn">#196</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump pytest from 7.4.4 to 8.1.0 in /basicmessage_storage
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:45:43 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/193" class=".btn">#193</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump indy-vdr from 0.3.4 to 0.4.1 in /basicmessage_storage
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:42:36 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/191" class=".btn">#191</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump marshmallow from 3.20.1 to 3.20.2 in /oid4vci
                </b>
            </td>
        </tr>
        <tr>
...
<p>Other changes:</p>
<ul>
<li>Officially support Python 3.12 (:pr:<code>2188</code>).
Thanks :user:<code>hugovk</code> for the PR.</li>
</ul>
</blockquote>
</details>
<details>
<summary>Commits</summary>
<ul>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/154d4c18ede4a2eabd1750df098d97225fae73f9"><code>154d4c1</code></a> Bump version and update changelog</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/a13e731b3eff85eb399ff9cdeffe7acc40e852ba"><code>a13e731</code></a> Bump LICENSE and fix changelog</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/755a074f337c1490e33e615170b6926478eefc9a"><code>755a074</code></a> Prevent false from appearing under logo (<a href="https://redirect.github.com/marshmallow-code/marshmallow/issues/2221">#2221</a>)</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/f98ad7fcdc4d89c18b0fac491cc2436e6eb06f60"><code>f98ad7f</code></a> Bump alabaster from 0.7.13 to 0.7.15</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/88ce4cb94c01a1bba100bc8ebdff24ed90c32969"><code>88ce4cb</code></a> [pre-commit.ci] pre-commit autoupdate</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/b1857ef1ea5bceeb8208991a84959624fd041055"><code>b1857ef</code></a> Bump autodocsumm from 0.2.11 to 0.2.12</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/86b879091a8e11c09ae22678d5df658bb674358f"><code>86b8790</code></a> [pre-commit.ci] pre-commit autoupdate (<a href="https://redirect.github.com/marshmallow-code/marshmallow/issues/2217">#2217</a>)</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/2ef3f448337a6c6fe129f19a7796d36a1bcb993f"><code>2ef3f44</code></a> Merge pull request <a href="https://redirect.github.com/marshmallow-code/marshmallow/issues/2215">#2215</a> from marshmallow-code/pre-commit_update</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/24855ac0cffeb1b8560a1c068ad9bced51402b6b"><code>24855ac</code></a> Fix flake8 issues</li>
<li><a href="https://github.com/marshmallow-code/marshmallow/commit/0547a8af7923041c0b1648258bff32a263aa4373"><code>0547a8a</code></a> Bump flake8-bugbear to 23.12.2 in pre-commit config</li>
<li>Additional commits viewable in <a href="https://github.com/marshmallow-code/marshmallow/compare/3.20.1...3.20.2">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=marshmallow&package-manager=pip&previous-version=3.20.1&new-version=3.20.2)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:32:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/190" class=".btn">#190</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump pytest-asyncio from 0.14.0 to 0.23.5 in /oid4vci
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:31:40 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/188" class=".btn">#188</a>
            </td>
            <td>
                <b>
                    chore(deps): Bump aries-askar from 0.3.0 to 0.3.1 in /oid4vci
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:29:58 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/187" class=".btn">#187</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump black from 23.7.0 to 24.2.0 in /oid4vci
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:29:12 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/186" class=".btn">#186</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump pytest-cov from 2.10.1 to 4.1.0 in /rpc
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:25:34 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/185" class=".btn">#185</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump indy-vdr from 0.3.4 to 0.4.1 in /rpc
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:24:51 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-plugins/pull/184" class=".btn">#184</a>
            </td>
            <td>
                <b>
                    chore(deps-dev): Bump pytest from 7.4.4 to 8.1.0 in /rpc
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2024-03-04 04:24:06 +0000 UTC
    </div>
</div>
