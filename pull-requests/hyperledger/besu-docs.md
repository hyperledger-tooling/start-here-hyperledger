...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/730" class=".btn">#730</a>
            </td>
            <td>
                <b>
                    add orion deprecation warnings
                </b>
            </td>
        </tr>
        <tr>
...
Add Orion deprecation warning/info to all privacy-related pages.
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/729" class=".btn">#729</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/727" class=".btn">#727</a>
            </td>
            <td>
                <b>
                    doc batch request support
                </b>
            </td>
        </tr>
        <tr>
...
Add info on sending batch requests over HTTP and WebSockets.
...
see https://hyperledger-besu--727.org.readthedocs.build/en/727/HowTo/Interact/APIs/Using-JSON-RPC-API/#http-and-websocket-requests
