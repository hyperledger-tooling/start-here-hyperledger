...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    WIP: updating the quickstart contract examples to use web3js-quorum
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/764" class=".btn">#764</a>
            </td>
            <td>
                <b>
                    Add docs for high level privacy plugin overview
                </b>
            </td>
        </tr>
        <tr>
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2021-08-06 11:23:07 +0000 UTC
    </div>
</div>
