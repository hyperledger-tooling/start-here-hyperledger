...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/799" class=".btn">#799</a>
            </td>
            <td>
                <b>
...
## Describe the change
Correct environment variable syntax.  Update formatting for consistency. 
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/798" class=".btn">#798</a>
            </td>
            <td>
                <b>
                    Add stratum metrics
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/795" class=".btn">#795</a>
            </td>
            <td>
                <b>
                    Document eth_feeHistory
                </b>
            </td>
        </tr>
        <tr>
...
## Describe the change
Adds eth_feeHistory API command
<!-- A clear and concise description of what this PR changes in the documentation. -->
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2021-09-13 15:57:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    update config file version of required-block
                </b>
            </td>
        </tr>
        <tr>
...
Config file version of this option was incorrect
...
- [ ] GitHub integration
    ...
    <div class="right-align">
        Created At 2021-09-09 04:22:58 +0000 UTC
    </div>
</div>
