...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/845" class=".btn">#845</a>
            </td>
            <td>
                <b>
...
## Describe the change
Update block time content
* add block period transition configuration
* add troubleshooting the `invalid block header` error
...
## Testing
https://hyperledger-besu--845.org.readthedocs.build/en/845
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2021-10-26 16:14:03 +0000 UTC
    </div>
</div>
