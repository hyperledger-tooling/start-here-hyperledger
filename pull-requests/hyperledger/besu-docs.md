...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/696" class=".btn">#696</a>
            </td>
            <td>
                <b>
                    add note about reinstalling command line tools when upgrading Besu
                </b>
            </td>
        </tr>
        <tr>
...
see https://hyperledger-besu--696.org.readthedocs.build/en/696/HowTo/Get-Started/Installation-Options/Install-Binaries/
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2021-04-27 21:54:33 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/692" class=".btn">#692</a>
            </td>
            <td>
                <b>
                    doc --static-nodes-file
                </b>
            </td>
        </tr>
        <tr>
...
Add documentation for --static-nodes-file.
...
https://hyperledger-besu--692.org.readthedocs.build/en/692/Reference/CLI/CLI-Syntax/#static-nodes-file
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/691" class=".btn">#691</a>
            </td>
            <td>
                <b>
                    add redirect for multinode example
                </b>
            </td>
        </tr>
        <tr>
...
see https://hyperledger-besu--691.org.readthedocs.build/en/691/Tutorials/Privacy/eeajs-Multinode-example/
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/690" class=".btn">#690</a>
            </td>
            <td>
                <b>
                    add projects using besu
                </b>
            </td>
        </tr>
        <tr>
...
Add Projects Using Besu page with Blockscout and Alethio block explorers.
...
https://hyperledger-besu--690.org.readthedocs.build/en/690/
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/689" class=".btn">#689</a>
            </td>
            <td>
                <b>
                    add info about API listening host
                </b>
            </td>
        </tr>
        <tr>
...
Add info about setting API listening host to allow remote connections to the sending transactions page.
...
see https://hyperledger-besu--689.org.readthedocs.build/en/689/
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/688" class=".btn">#688</a>
            </td>
            <td>
                <b>
                    update pet shop tutorial link
                </b>
            </td>
        </tr>
        <tr>
...
Update link to Truffle's pet shop tutorial on the private network example tutorial.
...
https://hyperledger-besu--688.org.readthedocs.build/en/688/Tutorials/Examples/Private-Network-Example/#smart-contract-and-dapp-usage
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/686" class=".btn">#686</a>
            </td>
            <td>
                <b>
                    clarify min-gas-price
                </b>
            </td>
        </tr>
        <tr>
...
Clarify expected behavior for min-gas-price configuration.
...
see https://hyperledger-besu--686.org.readthedocs.build/en/686/
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/685" class=".btn">#685</a>
            </td>
            <td>
                <b>
                    update status codes for PMT transaction
                </b>
            </td>
        </tr>
        <tr>
...
Add invalid status for PMT transactions.
...
see https://hyperledger-besu--685.org.readthedocs.build/en/685/
