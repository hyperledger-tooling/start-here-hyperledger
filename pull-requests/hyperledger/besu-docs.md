...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/907" class=".btn">#907</a>
            </td>
            <td>
                <b>
                    Update "proof of" usage
                </b>
            </td>
        </tr>
        <tr>
...
## Describe the change
Update usage of "proof of x" to be consistent.
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2021-12-20 20:55:16 +0000 UTC
    </div>
</div>
