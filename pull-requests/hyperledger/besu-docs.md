...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/997" class=".btn">#997</a>
            </td>
            <td>
                <b>
                    Clarify Tessera node behavior on start
                </b>
            </td>
        </tr>
        <tr>
...
## Describe the change
Clarify the `failure to connect` log is normal behavior for first Tessera node.
<!-- A clear and concise description of what this PR changes in the documentation. -->
...
don't hesitate to link an annotated screenshot or a small demo video. -->
    ...
    <div class="right-align">
        Created At 2022-03-24 19:33:17 +0000 UTC
    </div>
</div>
