...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/besu-docs/pull/1298" class=".btn">#1298</a>
            </td>
            <td>
                <b>
...
Document `engine_exchangeCapabilities`, `engine_getPayloadBodiesByHashV1`, and `engine_getPayloadBodiesByRangeV1`.
...
`engine_getPayloadBodiesByRangeV1`: https://hyperledger-besu--1298.org.readthedocs.build/en/1298/public-networks/reference/engine-api/#engine_getpayloadbodiesbyrangev1
    ...
    <div class="right-align">
        Created At 2023-04-05 20:21:35 +0000 UTC
    </div>
</div>
