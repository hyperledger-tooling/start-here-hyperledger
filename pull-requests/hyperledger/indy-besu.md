...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/indy-besu/pull/30" class=".btn">#30</a>
            </td>
            <td>
                <b>
                    Bump undici from 5.28.2 to 5.28.3 in /smart_contracts
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/indy-besu/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-02-16 18:44:58 +0000 UTC
    </div>
</div>
...
<div>
    ...
    <div class="right-align">
        Created At 2024-02-16 04:57:54 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/indy-besu/pull/26" class=".btn">#26</a>
            </td>
            <td>
                <b>
    ...
    <div class="right-align">
        Created At 2024-02-16 04:21:14 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/indy-besu/pull/25" class=".btn">#25</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            ...
            <td>
                Bumps the all-actions group with 4 updates: [actions/checkout](https://github.com/actions/checkout), [actions/setup-node](https://github.com/actions/setup-node), [actions/upload-artifact](https://github.com/actions/upload-artifact) and [actions/download-artifact](https://github.com/actions/download-artifact).
...
- `@dependabot unignore <dependency name> <ignore condition>` will remove the ignore condition of the specified dependency and ignore conditions
    ...
    <div class="right-align">
        Created At 2024-02-15 05:41:31 +0000 UTC
    </div>
</div>
