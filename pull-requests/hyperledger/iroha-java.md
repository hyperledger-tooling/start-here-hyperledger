...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha-java/pull/385" class=".btn">#385</a>
            </td>
            <td>
                <b>
                    Bump com.github.docker-java:docker-java from 3.3.0 to 3.3.4
                </b>
            </td>
        </tr>
        <tr>
...
- `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
    ...
    <div class="right-align">
        Created At 2023-10-31 05:16:35 +0000 UTC
    </div>
</div>
