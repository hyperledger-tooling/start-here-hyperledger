...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mediator-service/pull/28" class=".btn">#28</a>
            </td>
            <td>
                <b>
                    build(deps): bump minimist from 1.2.5 to 1.2.6 in /acapy/controller
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mediator-service/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-03-31 16:45:03 +0000 UTC
    </div>
</div>
