...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mediator-service/pull/45" class=".btn">#45</a>
            </td>
            <td>
                <b>
                    build(deps): bump decode-uri-component from 0.2.0 to 0.2.2 in /acapy/controller
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mediator-service/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-08 02:57:36 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mediator-service/pull/44" class=".btn">#44</a>
            </td>
            <td>
                <b>
                    build(deps): bump qs and express in /acapy/controller
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mediator-service/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-07 04:04:10 +0000 UTC
    </div>
</div>
