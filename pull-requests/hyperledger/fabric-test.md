...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-test/pull/468" class=".btn">#468</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/text from 0.3.7 to 0.3.8 in /tools/chaincode-integration/resources/chaincode/simple-go
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-test/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-02-23 10:44:06 +0000 UTC
    </div>
</div>
