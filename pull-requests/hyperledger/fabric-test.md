...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-test/pull/325" class=".btn">#325</a>
            </td>
            <td>
                <b>
                    Bump path-parse from 1.0.6 to 1.0.7 in /tools/chaincode-integration
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-test/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-08-11 22:09:34 +0000 UTC
    </div>
</div>
