...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-test/pull/378" class=".btn">#378</a>
            </td>
            <td>
                <b>
                    CI test - Ignore me
    ...
    <div class="right-align">
        Created At 2022-05-03 20:38:18 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-test/pull/376" class=".btn">#376</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /tools/chaincode-integration
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-test/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-29 17:37:43 +0000 UTC
    </div>
</div>
