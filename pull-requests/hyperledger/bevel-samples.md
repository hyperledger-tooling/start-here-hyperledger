...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/79" class=".btn">#79</a>
            </td>
            <td>
                <b>
                    Bump undici from 5.28.2 to 5.28.3 in /examples/supplychain-app/quorum/smartContracts
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-02-16 18:44:21 +0000 UTC
    </div>
</div>
