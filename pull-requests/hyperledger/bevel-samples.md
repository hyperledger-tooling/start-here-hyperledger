...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/39" class=".btn">#39</a>
            </td>
            <td>
                <b>
                    Bump word-wrap from 1.2.3 to 1.2.4 in /examples/supplychain-app/supplychain-frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-20 07:42:43 +0000 UTC
    </div>
</div>
