...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/83" class=".btn">#83</a>
            </td>
            <td>
                <b>
                    Bump es5-ext from 0.10.62 to 0.10.64 in /examples/supplychain-app/besu/smartContracts
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-02-27 19:19:02 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/82" class=".btn">#82</a>
            </td>
            <td>
                <b>
                    Bump es5-ext from 0.10.62 to 0.10.64 in /examples/supplychain-app/quorum/smartContracts
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-02-27 17:29:56 +0000 UTC
    </div>
</div>
