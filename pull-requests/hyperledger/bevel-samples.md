...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/38" class=".btn">#38</a>
            </td>
            <td>
                <b>
                    Bump tough-cookie and react-scripts in /examples/supplychain-app/supplychain-frontend
                </b>
            </td>
        </tr>
        <tr>
...
<li>Additional commits viewable in <a href="https://github.com/salesforce/tough-cookie/compare/v2.5.0...v4.1.3">compare view</a></li>
</ul>
</details>
<details>
<summary>Maintainer changes</summary>
<p>This version was pushed to npm by <a href="https://www.npmjs.com/~awaterma">awaterma</a>, a new releaser for tough-cookie since your current version.</p>
</details>
<br />
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-14 11:00:44 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/37" class=".btn">#37</a>
            </td>
            <td>
                <b>
                    Bump semver from 5.7.1 to 5.7.2 in /examples/supplychain-app/quorum/smartContracts
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-13 18:05:44 +0000 UTC
    </div>
</div>
