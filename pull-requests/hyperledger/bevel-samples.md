...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel-samples/pull/109" class=".btn">#109</a>
            </td>
            <td>
                <b>
                    Bump golang.org/x/net from 0.17.0 to 0.23.0 in /examples/supplychain-app/fabric/chaincode_rest_server/chaincode-external
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-04-19 12:35:23 +0000 UTC
    </div>
</div>
