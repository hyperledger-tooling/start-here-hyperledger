...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cacti/pull/2964" class=".btn">#2964</a>
            </td>
            <td>
                <b>
                    test(connector-besu): migrate to jest for v21-get-block-test.ts
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                1. Also added a couple of extra assertions to make the test more robust.
...
For rebasing and squashing, here's a [must read guide](https://github.com/servo/servo/wiki/Beginner's-guide-to-rebasing-and-squashing) for beginners.
    ...
    <div class="right-align">
        Created At 2023-12-26 05:49:12 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cacti/pull/2963" class=".btn">#2963</a>
            </td>
            <td>
                <b>
...
For rebasing and squashing, here's a [must read guide](https://github.com/servo/servo/wiki/Beginner's-guide-to-rebasing-and-squashing) for beginners.
    ...
    <div class="right-align">
        Created At 2023-12-22 20:32:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    chore:Update test_weaver-pre-release.yaml
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                As part of Security Testing Purpose ONLY
...
For rebasing and squashing, here's a [must read guide](https://github.com/servo/servo/wiki/Beginner's-guide-to-rebasing-and-squashing) for beginners.
    ...
    <div class="right-align">
        Created At 2023-12-22 10:36:02 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cacti/pull/2960" class=".btn">#2960</a>
            </td>
            <td>
                <b>
                    ci(weaver): added conditions to run only when affected corresponding files
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Temporary changes to weaver CI tests to run only when corresponding files have been affected, as discussed in the call.
...
For rebasing and squashing, here's a [must read guide](https://github.com/servo/servo/wiki/Beginner's-guide-to-rebasing-and-squashing) for beginners.
    ...
    <div class="right-align">
        Created At 2023-12-22 07:14:23 +0000 UTC
    </div>
</div>
