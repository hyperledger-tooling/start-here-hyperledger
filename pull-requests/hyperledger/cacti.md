...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/cacti/pull/2560" class=".btn">#2560</a>
            </td>
            <td>
                <b>
                    build(deps-dev): bump word-wrap from 1.2.3 to 1.2.4 in /weaver/common/policy-dsl
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/cacti/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-07-20 03:29:37 +0000 UTC
    </div>
</div>
