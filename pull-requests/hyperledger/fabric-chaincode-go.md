...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-chaincode-go/pull/113" class=".btn">#113</a>
            </td>
            <td>
                <b>
                    Bump google.golang.org/grpc from 1.64.0 to 1.64.1 in /v2 in the go_modules group across 1 directory
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Bumps the go_modules group with 1 update in the /v2 directory: [google.golang.org/grpc](https://github.com/grpc/grpc-go).
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-chaincode-go/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-07-09 21:56:19 +0000 UTC
    </div>
</div>
