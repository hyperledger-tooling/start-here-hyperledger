...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    Bump qs, body-parser and express in /examples/supplychain-app/fabric/express_nodeJs
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-12 08:29:45 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/2096" class=".btn">#2096</a>
            </td>
            <td>
                <b>
                    [besu] create tls cert using Cert-manager for besu network
                </b>
            </td>
        </tr>
        <tr>
...
Added cert-manager chart to shared/charts folder
Added configuration to create ambassador default tls certificate by cert-manager using lets-encrypt prod CA, as of now this is implemented only for besu network
...
#2036 
    ...
    <div class="right-align">
        Created At 2022-12-12 05:00:51 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/2095" class=".btn">#2095</a>
            </td>
            <td>
                <b>
                    Bump express from 4.17.1 to 4.17.3 in /examples/supplychain-app/quorum/express_nodeJS
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-12 03:00:15 +0000 UTC
    </div>
</div>
