...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1934" class=".btn">#1934</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /examples/supplychain-app/supplychain-frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-29 16:40:06 +0000 UTC
    </div>
</div>
