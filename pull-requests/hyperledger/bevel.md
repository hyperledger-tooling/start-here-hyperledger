...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1879" class=".btn">#1879</a>
            </td>
            <td>
                <b>
                    [docs] Update roadmap
    ...
    <div class="right-align">
        Created At 2022-02-28 12:52:55 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1878" class=".btn">#1878</a>
            </td>
            <td>
                <b>
                    [shared] Add supplychain image build
                </b>
            </td>
        </tr>
        <tr>
...
**Changelog**
- Add separate workflow file for Fabric, Corda and frontend
- Update sample network yamls, roles and tpl files to point docker registry to ghcr.io
...
#1823 
    ...
    <div class="right-align">
        Created At 2022-02-28 07:48:27 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1877" class=".btn">#1877</a>
            </td>
            <td>
                <b>
                    Bump url-parse from 1.5.7 to 1.5.10 in /examples/supplychain-app/supplychain-frontend
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-28 04:20:27 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1876" class=".btn">#1876</a>
            </td>
            <td>
                <b>
                    [quorum][besu]check and ensure that the store certs are successfully storing the crypto materials
                </b>
            </td>
        </tr>
        <tr>
...
#1762 
    ...
    <div class="right-align">
        Created At 2022-02-25 08:51:29 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/1875" class=".btn">#1875</a>
            </td>
            <td>
                <b>
                    [corda-ent] Hosted cordapps in github packages
                </b>
            </td>
        </tr>
        <tr>
...
**Changelog**
- Add gradlew publish logic in cordapps and workflows to add cordapps jar in github packages
- Fix corda node logs in endless loop
...
#1855 #1798 
    ...
    <div class="right-align">
        Created At 2022-02-24 11:23:20 +0000 UTC
    </div>
</div>
