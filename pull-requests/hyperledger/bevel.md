...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    refactoring charts to removing dependency on external tools and artifacts
                </b>
            </td>
        </tr>
        <tr>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/2081" class=".btn">#2081</a>
            </td>
            <td>
                <b>
                    Bump decode-uri-component from 0.2.0 to 0.2.2 in /platforms/r3-corda/images/doorman/website
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/bevel/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-04 17:34:45 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/bevel/pull/2080" class=".btn">#2080</a>
            </td>
            <td>
                <b>
                    Bump decode-uri-component from 0.2.0 to 0.2.2 in /examples/supplychain-app/fabric/chaincode_rest_server/rest-server
                </b>
            </td>
        </tr>
        <tr>
