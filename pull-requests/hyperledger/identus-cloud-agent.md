...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1229" class=".btn">#1229</a>
            </td>
            <td>
                <b>
                    chore: fix image centering in integration test
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ### Description: 
Rolled back `style="text-align: center"` to `align="center"` for readme in integration test
...
- [x] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-27 02:20:40 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1228" class=".btn">#1228</a>
            </td>
            <td>
                <b>
                    fix: Verification Policy Error Handling
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <span class="chip">pollux</span><span class="chip">cloud-agent</span><span class="chip">autoupdate</span>
            </td>
            <td>
                https://input-output.atlassian.net/browse/ATL-6837

            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2024-06-26 20:54:28 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1227" class=".btn">#1227</a>
            </td>
            <td>
                <b>
                    style: apply linters automatic fixes
    ...
    <div class="right-align">
        Created At 2024-06-26 19:27:21 +0000 UTC
    </div>
</div>
