...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    ci: fix auto-merge.yml file [skip ci]
                </b>
            </td>
        </tr>
        <tr>
...
- [ ] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-17 14:58:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1195" class=".btn">#1195</a>
            </td>
            <td>
                <b>
                    style: apply linters automatic fixes
    ...
    <div class="right-align">
        Created At 2024-06-17 14:06:48 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1194" class=".btn">#1194</a>
            </td>
            <td>
                <b>
        ...
        <tr>
            <td>
                <span class="chip">infra</span><span class="chip">autoupdate</span>
            </td>
            <td>
                ### Description: 
- make init-script.sh idempotent
- scalafix demo.py
...
- [x] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-17 14:04:17 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1193" class=".btn">#1193</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/identus-cloud-agent/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-06-17 13:16:07 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1184" class=".btn">#1184</a>
            </td>
            <td>
                <b>
...
- [x] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-14 11:13:22 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1182" class=".btn">#1182</a>
            </td>
            <td>
                <b>
                    feat: add oidc4vci protocol MVP
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <span class="chip">pollux</span><span class="chip">build</span><span class="chip">infra</span><span class="chip">shared</span><span class="chip">mercury</span><span class="chip">cloud-agent</span>
            </td>
            <td>
                ### Description: 
Summarize the changes you're submitting in a few sentences, including Jira ticket [ATL-5751](https://input-output.atlassian.net/browse/ATL-5751) if applicable.
...
- [ ] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-13 15:48:30 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1180" class=".btn">#1180</a>
            </td>
            <td>
                <b>
                    feat: Integrate ZIO failures and defects ADR in DID Registrar Controller and Mercury
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <span class="chip">pollux</span><span class="chip">mercury</span><span class="chip">castor</span><span class="chip">cloud-agent</span>
            </td>
            <td>
                ### Description: 
Integrate ZIO failures and defects ADR in DID Registrar Controller and Mercury
...
- [x] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-13 12:42:26 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1178" class=".btn">#1178</a>
            </td>
            <td>
                <b>
                    fix: add claims validation when creating oid4vci credential offer
                </b>
            </td>
        </tr>
        <tr>
...
- [ ] I have checked the PR title to follow the [conventional commit specification](https://www.conventionalcommits.org/en/v1.0.0/)
    ...
    <div class="right-align">
        Created At 2024-06-13 10:56:05 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/identus-cloud-agent/pull/1177" class=".btn">#1177</a>
            </td>
            <td>
                <b>
                    fix: present error handling Part 2
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                https://input-output.atlassian.net/browse/ATL-5775
