...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-test-harness/pull/98" class=".btn">#98</a>
            </td>
            <td>
                <b>
                    fix environment handling in manage script
                </b>
            </td>
        </tr>
        <tr>
...
This PR fixes some environment issues to support the BC Services Card test integration. The manage script now has a cleaner way to pass environment variables into the test container. 

It also fixes some typos in the main test workflow for test projects in allure. 
            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2022-10-13 00:15:51 +0000 UTC
    </div>
</div>
