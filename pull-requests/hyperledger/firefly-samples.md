...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/firefly-samples/pull/35" class=".btn">#35</a>
            </td>
            <td>
                <b>
                    Bump url-parse from 1.5.1 to 1.5.10 in /private-data-transfer-ui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/firefly-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-27 14:43:27 +0000 UTC
    </div>
</div>
