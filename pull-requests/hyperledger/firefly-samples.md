...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/firefly-samples/pull/40" class=".btn">#40</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /private-data-transfer-ui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/firefly-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-29 15:59:17 +0000 UTC
    </div>
</div>
