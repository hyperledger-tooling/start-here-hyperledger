...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/firefly-samples/pull/23" class=".btn">#23</a>
            </td>
            <td>
                <b>
                    Bump axios from 0.21.1 to 0.21.2 in /private-data-transfer-ui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/firefly-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2021-12-08 00:01:17 +0000 UTC
    </div>
</div>
