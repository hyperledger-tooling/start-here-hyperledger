...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/firefly-samples/pull/50" class=".btn">#50</a>
            </td>
            <td>
                <b>
                    Bump json5 from 1.0.1 to 1.0.2 in /private-data-transfer-ui
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/firefly-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-01-07 07:53:46 +0000 UTC
    </div>
</div>
