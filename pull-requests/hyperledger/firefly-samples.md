...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/firefly-samples/pull/24" class=".btn">#24</a>
            </td>
            <td>
                <b>
                    Bump follow-redirects from 1.14.1 to 1.14.7 in /private-data-transfer-cli
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/firefly-samples/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-01-15 08:18:14 +0000 UTC
    </div>
</div>
