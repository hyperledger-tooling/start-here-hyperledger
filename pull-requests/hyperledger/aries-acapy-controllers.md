...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-acapy-controllers/pull/82" class=".btn">#82</a>
            </td>
            <td>
                <b>
                    Bump json5 from 2.2.0 to 2.2.3 in /AliceFaberAcmeDemo/controllers/alice-controller
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-acapy-controllers/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-01-02 10:22:30 +0000 UTC
    </div>
</div>
