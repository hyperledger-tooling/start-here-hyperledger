...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-framework-javascript/pull/509" class=".btn">#509</a>
            </td>
            <td>
                <b>
...
Added a "declined" Proof State. Added a "decline request" method, allowing the holder to decline proof requests. 
...
- [x] Updated **documentation** for changed code and new or modified features.
    ...
    <div class="right-align">
        Created At 2021-10-31 01:55:23 +0000 UTC
    </div>
</div>
