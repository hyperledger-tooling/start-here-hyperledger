...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-protos/pull/97" class=".btn">#97</a>
            </td>
            <td>
                <b>
                    Bump protobufjs from 6.11.2 to 6.11.3 in /bindings/node
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/fabric-protos/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-06-03 01:39:52 +0000 UTC
    </div>
</div>
