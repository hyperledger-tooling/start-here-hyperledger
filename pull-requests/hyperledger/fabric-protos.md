...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/fabric-protos/pull/168" class=".btn">#168</a>
            </td>
            <td>
                <b>
                    Update Java Protobuf library to remove dependency issues
                </b>
            </td>
        </tr>
        <tr>
...
<!--- build breaks when submitting any other pull requests.                                      -->
    ...
    <div class="right-align">
        Created At 2022-12-01 14:21:07 +0000 UTC
    </div>
</div>
