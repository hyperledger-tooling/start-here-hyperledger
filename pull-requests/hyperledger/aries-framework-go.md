...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-framework-go/pull/3441" class=".btn">#3441</a>
            </td>
            <td>
                <b>
                    chore(deps): bump decode-uri-component from 0.2.0 to 0.2.2 in /cmd/aries-js-worker
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-framework-go/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-05 06:49:51 +0000 UTC
    </div>
</div>
