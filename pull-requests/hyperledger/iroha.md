...
- [ ] Versions of crates are bumped to `rc9`. 
            </td>
        </tr>
    </table>
    <div class="right-align">
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2812" class=".btn">#2812</a>
            </td>
            <td>
                <b>
                    Brand new bug report template
                </b>
            </td>
        </tr>
        <tr>
...
<!-- Keep in mind that the maintainer reviewing this PR may not be familiar with or have worked with the code here recently, so please walk us through the concepts. -->
Updated bug report
The sorting of items has been changed in a logical order.
Other trivial improves...
...
### Benefits
For simplicity and conciseness when creating defects.
<!-- What benefits will be realized by the code change? -->
...
-->
    ...
    <div class="right-align">
        Created At 2022-09-30 17:10:16 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2810" class=".btn">#2810</a>
            </td>
            <td>
                <b>
                    [fix] #2548: Warn on large genesis file
                </b>
            </td>
        </tr>
        <tr>
...
Put warning in logs if genesis file is larger or equal 1Gb.
...
Run iroha with genesis above 1Gb.

<!-- Point reviewers to the test, code example or documentation which shows usage example of this feature -->

### Alternate Designs *[optional]*

I take simplest possible approach, other designs could be considered.
...
-->
    ...
    <div class="right-align">
        Created At 2022-09-30 09:07:52 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2809" class=".btn">#2809</a>
            </td>
            <td>
                <b>
                    [ci]: Replace base image with docker cache
                </b>
            </td>
        </tr>
        <tr>
...
### Description of the Change
1. Remove building and pushing of the `iroha2-base` image.
2. Introduce one-in-one `Dockerfile` with build layers.
...
---
### Note
The listed drawbacks would be resolved within the current PR or later.

            </td>
        </tr>
    </table>
    <div class="right-align">
        Created At 2022-09-30 07:56:20 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2808" class=".btn">#2808</a>
            </td>
            <td>
                <b>
...
Add extra examples which provide more context for SDK developers in case `genesis.json` syntax changes once again. 
...
``` cargo run --bin kagami -- genesis ```
    ...
    <div class="right-align">
        Created At 2022-09-30 06:29:27 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2807" class=".btn">#2807</a>
            </td>
            <td>
                <b>
...
`Expression` can cause stack overflow when serializing non-Raw variant. I missed it in my PR previously.
@Erigara has mentioned it and I fixed.
...
- No recursion bug when serializing `Expression`
...
Probably we should add tests for it?
...
<!-- Point reviewers to the test, code example or documentation which shows usage example of this feature -->
    ...
    <div class="right-align">
        Created At 2022-09-29 18:24:41 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2806" class=".btn">#2806</a>
            </td>
            <td>
                <b>
                    [feature] #2521: `Identifiable` derive improvement
                </b>
            </td>
        </tr>
        <tr>
...
* add option delegate `Identifiable` to inner field
* add option to annotate `id` field
* automatically pick up the field named `id`
* derive for `Trigger`
* derive for structs in handshake
* adjust supertraits
...
-->
    ...
    <div class="right-align">
        Created At 2022-09-29 18:10:29 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2805" class=".btn">#2805</a>
            </td>
            <td>
                <b>
                    [fix] #2802: Fix env loading for configuration
                </b>
            </td>
        </tr>
        <tr>
...
- Fix load from env
- Add test to cover possible field types loaded from env
...
`./scripts/test_env.sh` and `docker-compose` working again + new test.
...
```
cargo test --package iroha_config_base --test simple -- test_load_from_env --exact --nocapture 
```
