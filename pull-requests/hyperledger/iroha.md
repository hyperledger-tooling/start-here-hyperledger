...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2319" class=".btn">#2319</a>
            </td>
            <td>
                <b>
                    [refactor] #2011: More descriptive config params
                </b>
            </td>
        </tr>
        <tr>
...
Refactor names of some parameter config variables to make them more descriptive, such as the omnipresent `mailbox`.
...
### Benefits
Hopefully improved understanding of what the changed variables are meant to represent.
<!-- What benefits will be realized by the code change? -->

### Possible Drawbacks
Quite a bit of API changes with env variables being renamed all over.
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-06 08:39:31 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2314" class=".btn">#2314</a>
            </td>
            <td>
                <b>
                    [refactor] #0000: extract FFI conversion logic to separate module
                </b>
            </td>
        </tr>
        <tr>
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-03 08:56:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2313" class=".btn">#2313</a>
            </td>
            <td>
                <b>
                    [fix] #2017: Fix role unregistration
                </b>
            </td>
        </tr>
        <tr>
...
Signed-off-by: Shanin Roman [shahin1000@yandex.ru](mailto:shanin1000@yandex.ru)
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-03 08:56:01 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2304" class=".btn">#2304</a>
            </td>
            <td>
                <b>
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-01 17:40:11 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2300" class=".btn">#2300</a>
            </td>
            <td>
                <b>
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-01 08:10:34 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2298" class=".btn">#2298</a>
            </td>
            <td>
                <b>
                    [ci]: Add @ilchu to codeowners
                </b>
            </td>
        </tr>
        <tr>
...
### Description of the Change
Alter `CODEOWNERS` to include @ilchu.
<!-- We must be able to understand the design of your change from this description. If we can't get a good idea of what the code will be doing from the description here, the pull request may be closed at the maintainers' discretion. -->
<!-- Keep in mind that the maintainer reviewing this PR may not be familiar with or have worked with the code here recently, so please walk us through the concepts. -->
...
-->
    ...
    <div class="right-align">
        Created At 2022-06-01 07:26:11 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2297" class=".btn">#2297</a>
            </td>
            <td>
                <b>
                    [fix] #2295: Fix unregister trigger bug
                </b>
            </td>
        </tr>
        <tr>
...
* Added `Trigger`-related match arm in `RegisterBox` execution
* Added test with trigger unregistration
* Fixed real bug with removing from `trigger::Set`, see changes
...
* Possibility to unregister trigger for external users
* New test
* Bug fixing
...
```bash
cargo test --package iroha_client --test mod -- integration::triggers::by_call_trigger::unregister_trigger --exact --nocapture 
```
...
<!-- Point reviewers to the test, code example or documentation which shows usage example of this feature -->
    ...
    <div class="right-align">
        Created At 2022-05-31 20:12:41 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2293" class=".btn">#2293</a>
            </td>
            <td>
                <b>
                    [documentation]: Update the git branch reference from "master" to "main"
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Updated the git branch reference from "master" to "main"

Signed-off-by: James Davis <james.davisphd@gmail.com>
...
-->
    ...
    <div class="right-align">
        Created At 2022-05-30 22:50:02 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/2291" class=".btn">#2291</a>
            </td>
            <td>
                <b>
...
-->
    ...
    <div class="right-align">
        Created At 2022-05-30 13:58:48 +0000 UTC
    </div>
</div>
