...
Currently all transactions are putted into the same queue, further improvement would be to introduce separate waiting buffer for the transactions that are waiting for more signatures.
...
-->
    ...
    <div class="right-align">
        Created At 2022-12-27 07:33:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3041" class=".btn">#3041</a>
            </td>
            <td>
                <b>
                    [fix] #2803: Return correct status code for signature errors
                </b>
            </td>
        </tr>
        <tr>
...
Fix unhandled rejection inside `torii`.
...
Correct response from the iroha.
