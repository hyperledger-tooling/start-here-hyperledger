...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1676" class=".btn">#1676</a>
            </td>
            <td>
                <b>
    ...
    <div class="right-align">
        Created At 2021-12-05 00:35:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1672" class=".btn">#1672</a>
            </td>
            <td>
                <b>
                    DO NOT MERGE: Testing self-hosted runners
                </b>
            </td>
        </tr>
        <tr>
    ...
    <div class="right-align">
        Created At 2021-12-03 16:35:03 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1670" class=".btn">#1670</a>
            </td>
            <td>
                <b>
                    [refactor]  #1661: `Cargo.toml` cleanup
                </b>
            </td>
        </tr>
        <tr>
...
-->
    ...
    <div class="right-align">
        Created At 2021-12-03 02:01:45 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1669" class=".btn">#1669</a>
            </td>
            <td>
                <b>
                    [refactor] #1668: fix new clippy lints in the code
                </b>
            </td>
        </tr>
        <tr>
...
* add `--no-default-features` to github workflow pipeline
...
There are a few I didn't know how to handle. Someone else can have a look
...
-->
    ...
    <div class="right-align">
        Created At 2021-12-02 18:51:12 +0000 UTC
    </div>
</div>
...
* use (private) type alias instead of a wrapper struct for versioned items
* docs no longer have reference to `_VersionedXXX` wrapper struct
...
just look at the generated docs:
```
...
you can now match on the enum, there is no need to make a distinction between `as_inner_v1` and `as_v1` and alike
