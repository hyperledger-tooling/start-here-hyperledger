...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3146" class=".btn">#3146</a>
            </td>
            <td>
                <b>
                    Fix in iroha-cpp library + added example of few transactions
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <span class="chip">Bug</span><span class="chip">1.x</span><span class="chip">CLI</span><span class="chip">Refactor</span><span class="chip">1.5</span><span class="chip">queries</span>
            </td>
            <td>
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-13 18:40:06 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3125" class=".btn">#3125</a>
            </td>
            <td>
                <b>
                    [fix] #3113: Revise unstable network tests.
                </b>
            </td>
        </tr>
        <tr>
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-08 14:45:36 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3123" class=".btn">#3123</a>
            </td>
            <td>
                <b>
                    [refactor] #2943: Derive `HasOrigin`
                </b>
            </td>
        </tr>
        <tr>
...
- Introduce `iroha_macro_utils` for macro building utilities reused through other crates;
- Add derive proc macro for `HasOrigin`.
...
```
cargo test --doc --package iroha_data_model_derive -- has_origin_derive --nocapture 
```
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-08 10:40:54 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3122" class=".btn">#3122</a>
            </td>
            <td>
                <b>
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-08 08:17:31 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3121" class=".btn">#3121</a>
            </td>
            <td>
                <b>
...
The issue I've been facing is how to make data model structs transparent for `iroha_core` and opaque for the client:
* wrote a simple macro that converts a struct to an opaque struct when linked without `transparent_api` feature
...
With this change we get the best of both worlds. We get opaque API for clients and transparent API for inner libraries of Iroha. I see no reason why Iroha libs wouldn't have access to inner workings of data model structs. It only forces us to clone or make weird workarounds 

### Possible Drawbacks

Not sure what can be done about opaque enums
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-08 06:51:28 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3120" class=".btn">#3120</a>
            </td>
            <td>
                <b>
                    [feature] #3119: Add `dropped_messages` metric
                </b>
            </td>
        </tr>
        <tr>
...
Fulfill DevOps request, provide more data to analyze iroha behavior. 
...
Start iroha and send `/metrics` request.
...
-->
    ...
    <div class="right-align">
        Created At 2023-02-07 14:18:30 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3118" class=".btn">#3118</a>
            </td>
            <td>
                <b>
