...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/990" class=".btn">#990</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/986" class=".btn">#986</a>
            </td>
            <td>
                <b>
                    Introduces Roles
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/984" class=".btn">#984</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/983" class=".btn">#983</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/982" class=".btn">#982</a>
            </td>
            <td>
                <b>
