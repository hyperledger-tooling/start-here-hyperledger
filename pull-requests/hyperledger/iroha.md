...
<div>
    <table>
        <tr>
            ...
            <td>
                <b>
                    [fix] #3249: Introduce PerfectBlockHash. Perfect as in finished.
                </b>
            </td>
        </tr>
        <tr>
...
Add `update_topology` and `update_state` function to encapsulate common functionality. 
...
I have tried const generic approach but it doesn't look very nice.
...
-->
    ...
    <div class="right-align">
        Created At 2023-03-13 09:46:14 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3300" class=".btn">#3300</a>
            </td>
            <td>
                <b>
...
- Added new permission validator for `NewParameter` isi
- This validator added to the main permission validator
- Increased max gas limit
...
Validator for a new instruction
...
We don't write new tests until we have new test system with Python
...
<!-- Point reviewers to the test, code example or documentation which shows usage example of this feature -->
    ...
    <div class="right-align">
        Created At 2023-03-12 16:56:37 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/3299" class=".btn">#3299</a>
            </td>
            <td>
                <b>
                    [feature] #3260: Wasm type inference
                </b>
            </td>
        </tr>
        <tr>
...
-->
    ...
    <div class="right-align">
        Created At 2023-03-10 12:35:47 +0000 UTC
    </div>
</div>
