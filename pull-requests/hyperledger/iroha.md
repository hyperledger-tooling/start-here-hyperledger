...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1870" class=".btn">#1870</a>
            </td>
            <td>
                <b>
                    Docs: Healthcheck Endpoint Information
                </b>
            </td>
        </tr>
        <tr>
...
Adds information about how to add healthcheck to the config and how it could help
...
None
    ...
    <div class="right-align">
        Created At 2022-02-06 18:09:54 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1861" class=".btn">#1861</a>
            </td>
            <td>
                <b>
                    [feature] #1766: Wasm permission validation
                </b>
            </td>
        </tr>
        <tr>
...
- adds permission validation to wasm runtime
- introduces `TransactionValidator` as a separate structure
- fixes deserialization of `SignaturesOf`
- ensures that `VersionedTransaction` is exchanged between peers instead of `VersionedAcceptedTransaction`
- deduplicates transaction limits in configuration of `torii`/`wasm` vs `sumeragi`
...
-->
    ...
    <div class="right-align">
        Created At 2022-02-01 15:34:15 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1860" class=".btn">#1860</a>
            </td>
            <td>
                <b>
...
The true solution will be the new account structure #1594 where an account is identified by its public key
    ...
    <div class="right-align">
        Created At 2022-02-01 10:15:49 +0000 UTC
    </div>
</div>
