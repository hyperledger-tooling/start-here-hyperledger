...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1297" class=".btn">#1297</a>
            </td>
            <td>
                <b>
                    [RDB] account details fix
                </b>
            </td>
        </tr>
        <tr>
...
### Description of the Change
Fixes problem with escape symbols in ```SetAccountDetail``` and ```CompareAndSetAccountDetail``` commands.
...
-->
    ...
    <div class="right-align">
        Created At 2021-07-29 08:14:49 +0000 UTC
    </div>
</div>
