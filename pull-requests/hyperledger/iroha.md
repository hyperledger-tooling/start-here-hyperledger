...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1781" class=".btn">#1781</a>
            </td>
            <td>
                <b>
                    [feature] #1749: no_std support for version, schema and macro libraries
                </b>
            </td>
        </tr>
        <tr>
...
`data_model` depends on these libraries. Consider this PR a prerequisite for `no_std` support in `data_model`
Replaced `thiserror` with `derive_more` in `iroha_version` because it's possible to implement just `Display` trait
...
-->
    ...
    <div class="right-align">
        Created At 2022-01-05 17:20:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/iroha/pull/1779" class=".btn">#1779</a>
            </td>
            <td>
                <b>
                    [feature] #1749: `no_std` in `data_model`
                </b>
            </td>
        </tr>
        <tr>
...
-->
    ...
    <div class="right-align">
        Created At 2022-01-05 10:18:24 +0000 UTC
    </div>
</div>
