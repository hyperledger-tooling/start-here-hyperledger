...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-askar/pull/68" class=".btn">#68</a>
            </td>
            <td>
                <b>
                    chore(deps): bump decode-uri-component from 0.2.0 to 0.2.2 in /wrappers/javascript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-askar/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-12-09 10:31:55 +0000 UTC
    </div>
</div>
