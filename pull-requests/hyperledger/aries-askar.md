...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-askar/pull/270" class=".btn">#270</a>
            </td>
            <td>
                <b>
                    build(deps): bump curve25519-dalek from 4.1.1 to 4.1.3 in the cargo group
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-askar/network/alerts).
    ...
    <div class="right-align">
        Created At 2024-06-18 22:22:59 +0000 UTC
    </div>
</div>
