...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-askar/pull/191" class=".btn">#191</a>
            </td>
            <td>
                <b>
                    build(deps): bump @babel/traverse from 7.22.17 to 7.23.2 in /wrappers/javascript
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-askar/network/alerts).
    ...
    <div class="right-align">
        Created At 2023-10-19 06:27:55 +0000 UTC
    </div>
</div>
