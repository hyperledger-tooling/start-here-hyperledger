...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/152" class=".btn">#152</a>
            </td>
            <td>
                <b>
                    Fix testing mechanics for future use
                </b>
            </td>
        </tr>
        <tr>
...
Some under-the-hood changes to make testing work for future changes. I removed the `App.test.tsx` test since it does not work and we'll need to write code a bit differently to make it more testable as we go.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2021-11-26 23:54:21 +0000 UTC
    </div>
</div>
