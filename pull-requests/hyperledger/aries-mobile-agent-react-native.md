...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/370" class=".btn">#370</a>
            </td>
            <td>
                <b>
                    chore: added indicio mainnet and demonet to ledgers
                </b>
            </td>
        </tr>
        <tr>
...
Added Indicio main net and demo net to ledgers

# Related Issues

https://indicio.atlassian.net/browse/AMO-405
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-07-13 19:37:12 +0000 UTC
    </div>
</div>
