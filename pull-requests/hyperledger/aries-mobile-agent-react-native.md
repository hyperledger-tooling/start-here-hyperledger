...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/289" class=".btn">#289</a>
            </td>
            <td>
                <b>
                    Fixed contact details params
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Signed-off-by: ryanindicio <ryan@indicio.tech>

# Summary of Changes

Params being passed to the Contact Details screen were not being destructured properly, causing the values to appear blank. 
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-04-15 16:18:45 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/288" class=".btn">#288</a>
            </td>
            <td>
                <b>
                    Bump follow-redirects from 1.14.7 to 1.14.9 in /core
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:53:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/287" class=".btn">#287</a>
            </td>
            <td>
                <b>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:52:36 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/286" class=".btn">#286</a>
            </td>
            <td>
                <b>
                    Bump async from 2.6.3 to 2.6.4 in /core
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:52:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/285" class=".btn">#285</a>
            </td>
            <td>
                <b>
                    Bump minimist from 1.2.5 to 1.2.6 in /core
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:52:10 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/284" class=".btn">#284</a>
            </td>
            <td>
                <b>
                    Bump plist from 3.0.4 to 3.0.5 in /core
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:52:06 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/283" class=".btn">#283</a>
            </td>
            <td>
                <b>
                    Bump ansi-regex from 4.1.0 to 4.1.1 in /core
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-04-14 21:51:32 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/282" class=".btn">#282</a>
            </td>
            <td>
                <b>
                    Proof request display
                </b>
            </td>
        </tr>
        <tr>
...
Updates the proof request details screen to work with `name` or `names` properties from requested attributes in proofs
Updates tests to reflect changes to components.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-04-14 17:54:54 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/280" class=".btn">#280</a>
            </td>
            <td>
                <b>
                    Adds testID and accessibilityLabel app-wide
                </b>
            </td>
        </tr>
        <tr>
...
In an effort to assist with application testing, `testID`s have been added to display elements. Translated `accessibilityLabel`s have been added to interactive elements. 
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-04-12 23:03:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/279" class=".btn">#279</a>
            </td>
            <td>
                <b>
                    Animate connection graphic
                </b>
            </td>
        </tr>
        <tr>
...
Add animation effect to the connection loading image.

https://user-images.githubusercontent.com/390891/163060392-01957186-584c-4211-b90f-50b1e6bd0276.mov
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-04-12 21:51:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/278" class=".btn">#278</a>
            </td>
            <td>
                <b>
                    Adding basic messaging support
                </b>
            </td>
        </tr>
        <tr>
...
Adds support for basic messaging between agents. Uses react-native-gifted-chat for UI. Basic messaging support required a version bump from React Hooks v0.1.2 -> v^0.2.0
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-04-12 19:06:52 +0000 UTC
    </div>
</div>
