...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/253" class=".btn">#253</a>
            </td>
            <td>
                <b>
                    Fixes issue with notification modal early display in release builds
                </b>
            </td>
        </tr>
        <tr>
            ...
            <td>
                Fixes an issue in release builds where notification modals display before user has actioned on either proof request or credential offer.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-03-21 22:36:35 +0000 UTC
    </div>
</div>
