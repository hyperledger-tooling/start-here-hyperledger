...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/972" class=".btn">#972</a>
            </td>
            <td>
                <b>
                    feat: revocation improvement
                </b>
            </td>
        </tr>
        <tr>
...
- Added functionality to disable share button on proof request screen if credential is revoked ***and*** the revocation date falls inside of the revocation interval. Previously the share button was enabled but the proof would fail during sending
- Removed useMemo from proof-request-templates hook. Memo was preventing the current time from being updated for the revocation interval in the proof templates.
- Fixed personally identifiable info flags on predicated
- Fixed wrong error displaying on revoked credentials

## Revoked before proof received
![image](https://github.com/hyperledger/aries-mobile-agent-react-native/assets/36937407/c4b64621-a9a3-4373-bd5e-d2af6433fbf5)

## Revoked after proof received
![image](https://github.com/hyperledger/aries-mobile-agent-react-native/assets/36937407/bc0b54a4-0e22-4ef1-aab8-f97beee19a3b)
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-09-18 18:18:53 +0000 UTC
    </div>
</div>
