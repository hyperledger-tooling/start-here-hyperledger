...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/857" class=".btn">#857</a>
            </td>
            <td>
                <b>
                    feat: added support for photo attribute in proof card
                </b>
            </td>
        </tr>
        <tr>
...
Added support for data uri photo attribute in proof request card

![Screen Shot 2023-06-21 at 2 53 33 PM](https://github.com/hyperledger/aries-mobile-agent-react-native/assets/36937407/de289e57-38b3-44b5-b141-c5a823ec695e)
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-21 21:54:23 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/855" class=".btn">#855</a>
            </td>
            <td>
                <b>
                    fix: refactor and clean up common remove modal
                </b>
            </td>
        </tr>
        <tr>
...
There was a lot of if/else that was better suited to switch statements, so did that. Also fixed some spelling
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-20 23:28:51 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/854" class=".btn">#854</a>
            </td>
            <td>
                <b>
                    fix: memory leak
...
Fix memory leak as noded in the related issue.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-20 23:21:53 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/852" class=".btn">#852</a>
            </td>
            <td>
                <b>
                    fix: add missing bouncy checkbox labels
                </b>
            </td>
        </tr>
        <tr>
...
Added missing labels to bouncy checkboxes

![IMG_0057](https://github.com/hyperledger/aries-mobile-agent-react-native/assets/32586431/1aaac1d3-39f1-4d9a-b258-6e54690eea7e)
![IMG_0058](https://github.com/hyperledger/aries-mobile-agent-react-native/assets/32586431/b8e7e3f7-ace2-40da-8cca-322e3903b2ba)
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-20 21:41:47 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/851" class=".btn">#851</a>
            </td>
            <td>
                <b>
                    fix: proof screen dismiss
                </b>
            </td>
        </tr>
        <tr>
...
Fix issue where the proof screen is not dismissed after rejecting a proof if it imediatly follows a offer.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-20 20:47:22 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/850" class=".btn">#850</a>
            </td>
            <td>
                <b>
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-06-20 19:47:25 +0000 UTC
    </div>
</div>
