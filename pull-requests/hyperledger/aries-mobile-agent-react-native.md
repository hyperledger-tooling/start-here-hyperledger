...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/739" class=".btn">#739</a>
            </td>
            <td>
                <b>
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2023-05-03 02:23:49 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/738" class=".btn">#738</a>
            </td>
            <td>
                <b>
                    feat: tour box features
                </b>
            </td>
        </tr>
        <tr>
...
Adds pagination dots to the the `TourBox` component, as well as the ability to swipe-navigate them, and expands the touch area of the navigation buttons with `hitSlop`

![tourbox_features](https://user-images.githubusercontent.com/32586431/235561393-9f4e61be-124c-4536-b0f1-b6a48f1da152.gif)
