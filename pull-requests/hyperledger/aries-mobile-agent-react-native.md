...
- Change the color and style of the details button on the proof screen;
- Change the field name in list (offer and proof) to be bold;
- List item background color to red for revoked credentials;
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-06-03 18:25:24 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/349" class=".btn">#349</a>
            </td>
            <td>
                <b>
                    Fix modal decline screen
                </b>
            </td>
        </tr>
        <tr>
...
- Use navigation to display the decline screen for offers and proofs;
- Display the header (navigation bar);
- Hide status bar for "Done" state on decline screen as per designs.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-06-03 14:17:19 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/348" class=".btn">#348</a>
            </td>
            <td>
                <b>
                    Amend license file to add Ontario team
                </b>
            </td>
        </tr>
        <tr>
...
Amend license file to add Ontario team
    ...
    <div class="right-align">
        Created At 2022-06-03 05:19:42 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/346" class=".btn">#346</a>
            </td>
            <td>
                <b>
                    Bump simple-plist from 1.1.1 to 1.3.1 in /core
                </b>
            </td>
        </tr>
        <tr>
...
<li>Additional commits viewable in <a href="https://github.com/wollardj/simple-plist/compare/v1.1.1...v1.3.1">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=simple-plist&package-manager=npm_and_yarn&previous-version=1.1.1&new-version=1.3.1)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/aries-mobile-agent-react-native/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-06-02 02:50:13 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/345" class=".btn">#345</a>
            </td>
            <td>
                <b>
...
Prevent device from landscape mode on Android
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-06-01 20:24:53 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/343" class=".btn">#343</a>
            </td>
            <td>
                <b>
                    Updates PIN code create and enter screens
                </b>
            </td>
        </tr>
        <tr>
...
New PIN create and enter screens using the `react-native-confirmation-code-field` package.
* Introduces PIN input component that replaces the text input fields in PIN create and enter screens
* Adds validation logic to ensure only digits are used for PIN
* Updated wording and alert messages for PIN screens 
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-05-31 20:53:09 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/342" class=".btn">#342</a>
            </td>
            <td>
                <b>
...
This PR makes it possible to display base64 image in the fields of a credential. We validate that the base64 data is either for a png or a jpeg.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-05-31 17:05:13 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/341" class=".btn">#341</a>
            </td>
            <td>
                <b>
                    Use common decline screen for offer and proof
                </b>
            </td>
        </tr>
        <tr>
...
Declining a proof or offer screens are about 98% the same. This PR consolidates the two screens into one that can be used differently by passing in the type of decline. Should reduce code duplicaitons.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-05-30 19:48:24 +0000 UTC
    </div>
</div>
