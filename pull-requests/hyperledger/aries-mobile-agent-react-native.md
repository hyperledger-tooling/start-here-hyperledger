...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/414" class=".btn">#414</a>
            </td>
            <td>
                <b>
                    Fixed connectionless proof request render error
                </b>
            </td>
        </tr>
        <tr>
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-08-19 22:37:30 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/413" class=".btn">#413</a>
            </td>
            <td>
                <b>
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-08-19 19:26:55 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/412" class=".btn">#412</a>
            </td>
            <td>
                <b>
...
Rework the use of biometrics to pave the way for future work and add state management so that the user can choose to use biometry as an authentication mechanism during on-boarding.
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-08-16 21:41:35 +0000 UTC
    </div>
</div>
