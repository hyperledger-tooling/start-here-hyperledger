...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/aries-mobile-agent-react-native/pull/435" class=".btn">#435</a>
            </td>
            <td>
                <b>
                    updated the image to use sizing from theme
                </b>
            </td>
        </tr>
        <tr>
...
Updated the logo on the loading screen to get width and height settings from the theme
...
_PR template adapted from the Python attrs project._
    ...
    <div class="right-align">
        Created At 2022-09-08 17:03:16 +0000 UTC
    </div>
</div>
