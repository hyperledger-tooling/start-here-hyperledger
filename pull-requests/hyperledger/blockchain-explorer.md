...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/blockchain-explorer/pull/308" class=".btn">#308</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/blockchain-explorer/pull/307" class=".btn">#307</a>
            </td>
            <td>
                <b>
...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/blockchain-explorer/pull/306" class=".btn">#306</a>
            </td>
            <td>
                <b>
