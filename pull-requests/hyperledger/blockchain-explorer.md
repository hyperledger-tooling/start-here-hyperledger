...
<div>
    <table>
        <tr>
            <td>
                PR <a href="https://github.com/hyperledger/blockchain-explorer/pull/281" class=".btn">#281</a>
            </td>
            <td>
                <b>
                    Bump url-parse from 1.5.3 to 1.5.10 in /client
                </b>
            </td>
        </tr>
        <tr>
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/hyperledger/blockchain-explorer/network/alerts).
    ...
    <div class="right-align">
        Created At 2022-02-26 03:21:21 +0000 UTC
    </div>
</div>
