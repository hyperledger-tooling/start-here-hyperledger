...
**Full Changelog**: https://github.com/hyperledger/aries-cloudagent-python/compare/0.7.3...0.7.4-rc4
            </td>
        </tr>
    </table>
    <a href="https://github.com/hyperledger/aries-cloudagent-python/releases/tag/0.7.4-rc4" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2022-06-21 22:23:36 +0000 UTC
    </span>
</div>
...
**Full Changelog**: https://github.com/hyperledger/aries-cloudagent-python/compare/0.7.3...0.7.4-rc3
            </td>
        </tr>
    </table>
    <a href="https://github.com/hyperledger/aries-cloudagent-python/releases/tag/0.7.4-rc3" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2022-06-16 19:41:37 +0000 UTC
    </span>
</div>
