...
For more about this release, please see the [CHANGELOG.md](https://github.com/hyperledger/aries-cloudagent-python/blob/0.8.2-rc2/CHANGELOG.md) file.

[PR \#2255]: https://github.com/hyperledger/aries-cloudagent-python/pull/2255
[PR \#2233]: https://github.com/hyperledger/aries-cloudagent-python/pull/2233
...
**Full Changelog**: https://github.com/hyperledger/aries-cloudagent-python/compare/0.8.1...0.8.2-rc2
            </td>
        </tr>
    </table>
    <a href="https://github.com/hyperledger/aries-cloudagent-python/releases/tag/0.8.2-rc2" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2023-06-28 18:04:56 +0000 UTC
    </span>
</div>
