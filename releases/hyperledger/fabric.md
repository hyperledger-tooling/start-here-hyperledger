...
<div>
    <table>
        ...
        <tr>
            ...
            <td>
                v2.5.2 Release Notes - June 2, 2023
===================================
...
[#4246](https://github.com/hyperledger/fabric/pull/4246)


Dependencies
------------
Fabric v2.5.2 has been tested with the following dependencies:
* Go 1.20.4
* CouchDB v3.3.2
...
[documentation for enabling the new lifecycle](https://hyperledger-fabric.readthedocs.io/en/release-2.2/enable_cc_lifecycle.html).
    ...
    <a href="https://github.com/hyperledger/fabric/releases/tag/v2.5.2" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2023-06-02 17:35:30 +0000 UTC
    </span>
</div>
...
It may also happen upon restart if the peer has stopped while committing a block to the state database.
The fix ensures that the private data collection update can be processed during state database rebuild.
[#4248](https://github.com/hyperledger/fabric/pull/4248)
...
[documentation for enabling the new lifecycle](https://hyperledger-fabric.readthedocs.io/en/release-2.2/enable_cc_lifecycle.html).
    ...
    <a href="https://github.com/hyperledger/fabric/releases/tag/v2.2.12" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2023-06-02 17:25:39 +0000 UTC
    </span>
</div>
