...
* [tokens] Only Use broadcastName for Multi-Party Namespaces by @hfuss in https://github.com/hyperledger/firefly/pull/1203
* [resolver] Unit Test for URL Encoding Key by @hfuss in https://github.com/hyperledger/firefly/pull/1214
...
**Full Changelog**: https://github.com/hyperledger/firefly/compare/v1.2.0...v1.3.0-rc.1
    ...
    <a href="https://github.com/hyperledger/firefly/releases/tag/v1.3.0-rc.1" class=".btn">
        View on GitHub
    </a>
    <span class="right-align">
        Created At 2024-03-04 18:10:39 +0000 UTC
    </span>
</div>
