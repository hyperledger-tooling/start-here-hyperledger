...
**Full Changelog**: https://github.com/hyperledger/besu/compare/24.1.2...24.2.0-RC1
...
`docker pull ghcr.io/hyperledger:24.2.0-RC2`
...
<div>
    <table>
        ...
        <tr>
            ...
            <td>
                ## 24.2.0-RC1 Has been found to be a bad release. This page will be preserved, however artifacts have been removed. Please use 24.1.2 or wait for RC2
